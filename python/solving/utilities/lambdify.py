...
from solving.external import import_module # noqa:F401
from solving.utilities.exceptions import sympy_deprecation_warning
from solving.utilities.decorator import doctest_depends_on
from solving.utilities.iterables import (is_sequence, iterable,
    NotIterable, flatten)
from solving.utilities.misc import filldedent
...
MODULES = {
    ...
    "solving": (SYMPY, SYMPY_DEFAULT, {}, (
        "from solving.functions import *",
        "from solving.matrices import *",
        "from solving import Integral, pi, oo, nan, zoo, E, I",)),
...
def _import(module, reload=False):
    ...
    "mpmath", "numpy", "solving", "tensorflow", "jax".
    ...
    **In general: you should create lambdified functions for one module (say,
    ...
    if printer is None:
        if _module_present('mpmath', namespaces):
            from solving.printing.pycode import MpmathPrinter as Printer # type: ignore
        elif _module_present('scipy', namespaces):
            from solving.printing.numpy import SciPyPrinter as Printer # type: ignore
        elif _module_present('numpy', namespaces):
            from solving.printing.numpy import NumPyPrinter as Printer # type: ignore
        elif _module_present('cupy', namespaces):
            from solving.printing.numpy import CuPyPrinter as Printer # type: ignore
        elif _module_present('jax', namespaces):
            from solving.printing.numpy import JaxPrinter as Printer # type: ignore
        elif _module_present('numexpr', namespaces):
            from solving.printing.lambdarepr import NumExprPrinter as Printer # type: ignore
        elif _module_present('tensorflow', namespaces):
            from solving.printing.tensorflow import TensorflowPrinter as Printer # type: ignore
        elif _module_present('torch', namespaces):
            from solving.printing.pytorch import TorchPrinter as Printer  # type: ignore
        elif _module_present('solving', namespaces):
            from solving.printing.pycode import SymPyPrinter as Printer # type: ignore
        elif _module_present('cmath', namespaces):
            from solving.printing.pycode import CmathPrinter as Printer # type: ignore
        else:
            from solving.printing.pycode import PythonCodePrinter as Printer # type: ignore
        user_functions = {}
        for m in namespaces[::-1]:
...
or tuple for the function arguments.
    ...
    if cse == True:
        from solving.simplify.cse_main import cse as _cse
...
def lambdastr(args, expr, printer=None, dummify=None):
    ...
    from solving.matrices import DeferredVector
    from solving.core.basic import Basic
    from solving.core.function import (Derivative, Function)
    ...
    if printer is not None:
        ...
        from solving.printing.lambdarepr import lambdarepr
...
class _EvaluatorPrinter:
    def __init__(self, printer=None, dummify=False):
        ...
        #XXX: This has to be done here because of circular imports
        from solving.printing.lambdarepr import LambdaPrinter
    ...
    def doprint(self, funcname, args, expr, *, cses=()):
        ...
        """
        from solving.core.symbol import Dummy
    ...
    def _preprocess(self, args, expr, cses=(), _dummies_dict=None):
        ...
        from solving.core.function import (Derivative, Function)
        from solving.core.symbol import Dummy, uniquely_named_symbol
        from solving.matrices import DeferredVector
        from solving.core.expr import Expr
    ...
    def _handle_Subs(self, expr, out):
        ...
        from solving.core.basic import Basic
        from solving.core.function import Subs
        from solving.core.symbol import Dummy
        from solving.matrices.matrixbase import MatrixBase
...
def _imp_namespace(expr, namespace=None):
    ...
    from solving.core.function import FunctionClass
...
def implemented_function(symfunc, implementation):
    ...
    """
    # Delayed import to avoid circular imports
    from solving.core.function import UndefinedFunction
...
def _too_large_for_docstring(expr, limit):
    ...
    from solving.core.traversal import postorder_traversal
