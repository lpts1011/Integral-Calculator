...
def debug_decorator(func):
    """If SOLVING_DEBUG is True, it will print a nice execution tree with
...
def debug(*args):
    """
    Print ``*args`` if SOLVING_DEBUG is True, else do nothing.
    """
    from solving import SOLVING_DEBUG
    if SOLVING_DEBUG:
...
def debugf(string, args):
    """
    Print ``string%args`` if SOLVING_DEBUG is True, else do nothing. This is
