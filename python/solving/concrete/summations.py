...
from solving.calculus.singularities import is_decreasing
from solving.calculus.accumulationbounds import AccumulationBounds
...
from solving.core.function import Derivative, expand
from solving.core.mul import Mul
from solving.core.numbers import Float, _illegal
from solving.core.relational import Eq
from solving.core.singleton import S
from solving.core.sorting import ordered
from solving.core.symbol import Dummy, Wild, Symbol, symbols
from solving.functions.combinatorial.factorials import factorial
from solving.functions.combinatorial.numbers import bernoulli, harmonic
...
from solving.functions.elementary.trigonometric import cot, csc
...
from solving.logic.boolalg import And, Not
from solving.polys.partfrac import apart
from solving.polys.polyerrors import PolynomialError, PolificationFailed
from solving.polys.polytools import parallel_poly_from_expr, Poly, factor
from solving.polys.rationaltools import together
from solving.series.limitseq import limit_seq
from solving.series.order import O
from solving.series.residues import residue
from solving.sets.contains import Contains
from solving.sets.sets import FiniteSet, Interval
...
class Sum(AddWithLimits, ExprWithIntLimits):
    ...
    def _eval_simplify(self, **kwargs):
        ...
        from solving.simplify.simplify import factor_sum, sum_combine
...
def eval_sum_symbolic(f, limits):
    ...
    if not (a.has(S.Infinity, S.NegativeInfinity) or
        ...
        if isinstance(r, (Mul,Add)):
            from solving.simplify.radsimp import denom
            from solving.solvers.solvers import solve
...
def _eval_sum_hyper(f, i, a):
    ...
    from solving.simplify.simplify import hypersimp
    hs = hypersimp(f, i)
    if hs is None:
        return None
