...
from solving.assumptions.assume import (global_assumptions, Predicate,
        AppliedPredicate)
from solving.assumptions.cnf import CNF, EncodedCNF, Literal
from solving.core import sympify
from solving.core.kind import BooleanKind
from solving.core.relational import Eq, Ne, Gt, Lt, Ge, Le
from solving.logic.inference import satisfiable
from solving.utilities.decorator import memoize_property
...
def ask(proposition, assumptions=True, context=global_assumptions):
    ...
    **Syntax**
    ...
    sympy.assumptions.refine.refine : Simplification using assumptions.
        ...
        be determined.
    """
    from solving.assumptions.satask import satask
    from solving.assumptions.lra_satask import lra_satask
    from solving.logic.algorithms.lra_theory import UnhandledInput
...
from solving.assumptions.ask_generated import (get_all_known_facts,
