...
from solving.assumptions.assume import AppliedPredicate, Predicate
from solving.core.relational import Eq, Ne, Gt, Lt, Ge, Le
from solving.core.singleton import S
from solving.logic.boolalg import Or, And, Not, Xnor
from solving.logic.boolalg import (Equivalent, ITE, Implies, Nand, Nor, Xor)
...
class CNF:
    ...
    @classmethod
    def to_CNF(cls, expr):
        from solving.assumptions.facts import get_composite_predicates
