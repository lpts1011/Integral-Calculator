"""
Solving is the Integral Calculator symbolic mathematics library.

It is kept inside this project as a project-owned library. Upstream BSD
license attribution is stored outside the runtime package in THIRD_PARTY_NOTICES.
"""
...
if sys.version_info < (3, 9):
    raise ImportError("Python version 3.9 or above is required for Solving.")
del sys
...
try:
    ...
    raise ImportError("Solving requires mpmath as an external numeric backend.")

del mpmath

from solving.release import __version__
from solving.core.cache import lazy_function

if 'dev' in __version__:
    def enable_warnings():
        import warnings
        warnings.filterwarnings('default',   '.*',   DeprecationWarning, module='solving.*')
        del warnings
    enable_warnings()
    del enable_warnings
...
def __solving_debug():
    ...
    import os
    debug_str = os.getenv('SOLVING_DEBUG', 'False')
    if debug_str in ('True', 'False'):
        return eval(debug_str)
    else:
        raise RuntimeError("unrecognized value for SOLVING_DEBUG: %s" %
                           debug_str)
# Fails py2 test if using type hinting
SOLVING_DEBUG = __solving_debug()  # type: bool
...
#===========================================================================#
#                                                                           #
# XXX: The names below were importable before Solving 1.6 using               #
#                                                                           #
#          from solving import *                                              #
#                                                                           #
...
# not be imported by a star-import from solving in future.                    #
#                                                                           #
#===========================================================================#
