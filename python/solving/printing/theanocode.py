...
if theano:
    ...
    mapping = {
            ...
            solving.Abs: tt.abs_,
            solving.sign: tt.sgn,
            solving.ceiling: tt.ceil,
            solving.floor: tt.floor,
            solving.log: tt.log,
            solving.exp: tt.exp,
            solving.sqrt: tt.sqrt,
            solving.cos: tt.cos,
            solving.acos: tt.arccos,
            solving.sin: tt.sin,
            solving.asin: tt.arcsin,
            solving.tan: tt.tan,
            solving.atan: tt.arctan,
            solving.atan2: tt.arctan2,
            solving.cosh: tt.cosh,
            solving.acosh: tt.arccosh,
            solving.sinh: tt.sinh,
            solving.asinh: tt.arcsinh,
            solving.tanh: tt.tanh,
            solving.atanh: tt.arctanh,
            solving.re: tt.real,
            solving.im: tt.imag,
            solving.arg: tt.angle,
            solving.erf: tt.erf,
            solving.gamma: tt.gamma,
            solving.loggamma: tt.gammaln,
            solving.Pow: tt.pow,
            solving.Eq: tt.eq,
            solving.StrictGreaterThan: tt.gt,
            solving.StrictLessThan: tt.lt,
            solving.LessThan: tt.le,
            solving.GreaterThan: tt.ge,
            solving.And: tt.and_,
            solving.Or: tt.or_,
            solving.Max: tt.maximum,  # SymPy accept >2 inputs, Theano only 2
            solving.Min: tt.minimum,  # SymPy accept >2 inputs, Theano only 2
            solving.conjugate: tt.conj,
            solving.core.numbers.ImaginaryUnit: lambda:tt.complex(0,1),
            # Matrices
            solving.MatAdd: tt.Elemwise(ts.add),
            solving.HadamardProduct: tt.Elemwise(ts.mul),
            solving.Trace: tlinalg.trace,
            solving.Determinant : tlinalg.det,
            solving.Inverse: tlinalg.matrix_inverse,
            solving.Transpose: tt.DimShuffle((False, False), [1, 0]),
    }
