...
from solving.core.numbers import Integer, IntegerConstant, equal_valued
...
class MapleCodePrinter(CodePrinter):
    ...
    def _print_Identity(self, expr):
        if isinstance(expr.rows, (Integer, IntegerConstant)):
            return self._print(solving.SparseMatrix(expr))
        else:
    ...
    def _print_MatMul(self, expr):
        ...
        _const = None
        if not isinstance(_fact_list[0], (solving.MatrixBase, solving.MatrixExpr,
                                          solving.MatrixSlice, solving.MatrixSymbol)):
