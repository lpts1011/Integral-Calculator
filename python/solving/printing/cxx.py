...
class _CXXCodePrinterBase:
    ...
    def _print_Min(self, expr):
        from solving.functions.elementary.miscellaneous import Min
        if len(expr.args) == 1:
            return self._print(expr.args[0])
