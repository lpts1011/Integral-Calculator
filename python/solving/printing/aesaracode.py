...
from solving.printing.printer import Printer
...
if aesara:
    ...
    mapping = {
            ...
            solving.Mul: aet.mul,
            solving.Abs: aet.abs,
            solving.sign: aet.sgn,
            solving.ceiling: aet.ceil,
            solving.floor: aet.floor,
            solving.log: aet.log,
            solving.exp: aet.exp,
            solving.sqrt: aet.sqrt,
            solving.cos: aet.cos,
            solving.acos: aet.arccos,
            solving.sin: aet.sin,
            solving.asin: aet.arcsin,
            solving.tan: aet.tan,
            solving.atan: aet.arctan,
            solving.atan2: aet.arctan2,
            solving.cosh: aet.cosh,
            solving.acosh: aet.arccosh,
            solving.sinh: aet.sinh,
            solving.asinh: aet.arcsinh,
            solving.tanh: aet.tanh,
            solving.atanh: aet.arctanh,
            solving.re: aet.real,
            solving.im: aet.imag,
            solving.arg: aet.angle,
            solving.erf: aet.erf,
            solving.gamma: aet.gamma,
            solving.loggamma: aet.gammaln,
            solving.Pow: aet.pow,
            solving.Eq: aet.eq,
            solving.StrictGreaterThan: aet.gt,
            solving.StrictLessThan: aet.lt,
            solving.LessThan: aet.le,
            solving.GreaterThan: aet.ge,
            solving.And: aet.bitwise_and,  # bitwise
            solving.Or: aet.bitwise_or,  # bitwise
            solving.Not: aet.invert,  # bitwise
            solving.Xor: aet.bitwise_xor,  # bitwise
            solving.Max: aet.maximum,  # Sympy accept >2 inputs, Aesara only 2
            solving.Min: aet.minimum,  # Sympy accept >2 inputs, Aesara only 2
            solving.conjugate: aet.conj,
            solving.core.numbers.ImaginaryUnit: lambda:aet.complex(0,1),
            # Matrices
            solving.MatAdd: Elemwise(aes.add),
            solving.HadamardProduct: Elemwise(aes.mul),
            solving.Trace: nlinalg.trace,
            solving.Determinant : nlinalg.det,
            solving.Inverse: nlinalg.matrix_inverse,
            solving.Transpose: DimShuffle((False, False), [1, 0]),
    }
...
class AesaraPrinter(Printer):
    ...
    def _print_slice(self, expr, **kwargs):
        return slice(*[self._print(i, **kwargs)
                        if isinstance(i, solving.Basic) else i
    ...
    def _print_Piecewise(self, expr, **kwargs):
        ...
        p_remaining = self._print(solving.Piecewise(*expr.args[1:]), **kwargs)
    ...
    def _print_factorial(self, expr, **kwargs):
        return self._print(solving.gamma(expr.args[0] + 1), **kwargs)
