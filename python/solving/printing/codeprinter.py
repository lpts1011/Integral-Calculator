...
from solving.core import Add, Mul, Pow, S, sympify, Float
from solving.core.basic import Basic
from solving.core.expr import Expr, UnevaluatedExpr
from solving.core.function import Lambda
from solving.core.mul import _keep_coeff
...
def _convert_python_lists(arg):
    if isinstance(arg, list):
        from solving.codegen.abstract_nodes import List
...
class CodePrinter(StrPrinter):
    ...
    def doprint(self, expr, assign_to=None):
        ...
        from solving.codegen.ast import CodeBlock, Assignment
    ...
    def _doprint_loops(self, expr, assign_to=None):
        ...
        if self._settings.get('contract', True):
            from solving.tensor import get_contraction_structure
    ...
    def _get_expression_indices(self, expr, assign_to):
        from solving.tensor import get_indices
    ...
    def _print_Assignment(self, expr):
        from solving.codegen.ast import Assignment
        from solving.functions.elementary.piecewise import Piecewise
        from solving.matrices.expressions.matexpr import MatrixSymbol
        from solving.tensor.indexed import IndexedBase
        lhs = expr.lhs
        rhs = expr.rhs
...
def ccode(expr, assign_to=None, standard='c99', **settings):
    ...
    A[2] = sin(x);
    """
    from solving.printing.c import c_code_printers
...
def fcode(expr, assign_to=None, **settings):
    ...
    >>> print(fcode(mat, A))
          ...
          A(3, 1) = sin(x)
    """
    from solving.printing.fortran import FCodePrinter
...
def cxxcode(expr, assign_to=None, standard='c++11', **settings):
    ...
    from solving.printing.cxx import cxx_code_printers
...
def rust_code(expr, assign_to=None, **settings):
    ...
    """
    from solving.printing.rust import RustCodePrinter
