...
from solving.core.numbers import equal_valued, Float
from solving.codegen.ast import (
...
from solving.printing.codeprinter import CodePrinter, requires
...
from solving.printing.codeprinter import ccode, print_ccode # noqa:F401
...
def get_math_macros():
    ...
    """
    from solving.codegen.cfunctions import log2, Sqrt
...
class C89CodePrinter(CodePrinter):
    ...
    def _print_Declaration(self, decl):
        from solving.codegen.cnodes import restrict
        var = decl.variable
        val = var.value
        if var.type == untyped:
