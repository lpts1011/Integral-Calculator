...
import solving
from solving.core import Add, Mul
from solving.core import Symbol, Expr, Float, Rational, Integer, Basic
from solving.core.function import UndefinedFunction, Function
from solving.core.relational import Relational, Unequality, Equality, LessThan, GreaterThan, StrictLessThan, StrictGreaterThan
from solving.functions.elementary.complexes import Abs
from solving.functions.elementary.exponential import exp, log, Pow
from solving.functions.elementary.hyperbolic import sinh, cosh, tanh
...
from solving.functions.elementary.trigonometric import sin, cos, tan, asin, acos, atan, atan2
from solving.logic.boolalg import And, Or, Xor, Implies, Boolean
from solving.logic.boolalg import BooleanTrue, BooleanFalse, BooleanFunction, Not, ITE
from solving.printing.printer import Printer
from solving.sets import Interval
from mpmath.libmp.libmpf import prec_to_dps, to_str as mlib_to_str
from solving.assumptions.assume import AppliedPredicate
from solving.assumptions.relation.binrel import AppliedBinaryRelation
from solving.assumptions.ask import Q
from solving.assumptions.relation.equality import StrictGreaterThanPredicate, StrictLessThanPredicate, GreaterThanPredicate, LessThanPredicate, EqualityPredicate
...
def smtlib_code(
    ...
    expr = [
        solving.sympify(_, strict=True, evaluate=False, convert_xor=False)
        for _ in expr
    ]
