...
from solving.core import Add, S, Mul, Pow, oo
from solving.core.containers import Tuple
from solving.core.expr import AtomicExpr, Expr
from solving.core.function import (Function, Derivative, AppliedUndef, diff,
    expand, expand_mul, Subs)
from solving.core.multidimensional import vectorize
from solving.core.numbers import nan, zoo, Number
from solving.core.relational import Equality, Eq
from solving.core.sorting import default_sort_key, ordered
from solving.core.symbol import Symbol, Wild, Dummy, symbols
from solving.core.sympify import sympify
from solving.core.traversal import preorder_traversal

from solving.logic.boolalg import (BooleanAtom, BooleanTrue,
                                BooleanFalse)
from solving.functions import exp, log, sqrt
from solving.functions.combinatorial.factorials import factorial
from solving.integrals.integrals import Integral
from solving.polys import (Poly, terms_gcd, PolynomialError, lcm)
from solving.polys.polytools import cancel
from solving.series import Order
from solving.series.series import series
from solving.simplify import (collect, logcombine, powsimp,  # type: ignore
    separatevars, simplify, cse)
from solving.simplify.radsimp import collect_const
from solving.solvers import checksol, solve

from solving.utilities import numbered_symbols
from solving.utilities.iterables import uniq, sift, iterable
from solving.solvers.deutils import _preprocess, ode_order, _desolve
...
def dsolve(eq, func=None, hint="default", simplify=True,
    ...
    **Hints**
    ...
    """
    if iterable(eq):
        from solving.solvers.ode.systems import dsolve_system
