...
"""
from solving.core import Pow
from solving.core.function import Derivative, AppliedUndef
...
def _desolve(eq, func=None, hint="default", ics=None, simplify=True, *, prep=True, **kwargs):
    ...
    if type == 'ode':
        from solving.solvers.ode import classify_ode, allhints
        classifier = classify_ode
        string = 'ODE '
        dummy = ''

    elif type == 'pde':
        from solving.solvers.pde import classify_pde, allhints
