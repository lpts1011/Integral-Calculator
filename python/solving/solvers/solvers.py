...
from solving.core import (S, Add, Symbol, Dummy, Expr, Mul)
from solving.core.assumptions import check_assumptions
from solving.core.exprtools import factor_terms
from solving.core.function import (expand_mul, expand_log, Derivative,
                                 AppliedUndef, UndefinedFunction, nfloat,
                                 Function, expand_power_exp, _mexpand, expand,
                                 expand_func)
from solving.core.logic import fuzzy_not, fuzzy_and
from solving.core.numbers import Float, Rational, _illegal
from solving.core.intfunc import integer_log, ilcm
from solving.core.power import Pow
from solving.core.relational import Eq, Ne
from solving.core.sorting import ordered, default_sort_key
from solving.core.sympify import sympify, _sympify
from solving.core.traversal import preorder_traversal
from solving.logic.boolalg import And, BooleanAtom

from solving.functions import (log, exp, LambertW, cos, sin, tan, acos, asin, atan,
...
from solving.functions.elementary.piecewise import piecewise_fold, Piecewise
...
from solving.simplify import (simplify, collect, powsimp, posify,  # type: ignore
    powdenest, nsimplify, denom, logcombine, sqrtdenest, fraction,
    separatevars)
from solving.simplify.sqrtdenest import sqrt_depth
from solving.simplify.fu import TR1, TR2i, TR10, TR11
from solving.strategies.rl import rebuild
from solving.matrices.exceptions import NonInvertibleMatrixError
from solving.matrices import Matrix, zeros
from solving.polys import roots, cancel, factor, Poly
from solving.polys.solvers import sympy_eqs_to_ring, solve_lin_sys
from solving.polys.polyerrors import GeneratorsNeeded, PolynomialError
from solving.polys.polytools import gcd
from solving.utilities.lambdify import lambdify
from solving.utilities.misc import filldedent, debugf
from solving.utilities.iterables import (connected_components,
    generate_bell, uniq, iterable, is_sequence, subsets, flatten, sift)
from solving.utilities.decorator import conserve_mpmath_dps
...
def checksol(f, symbol, sol=None, **flags):
    ...
    """
    from solving.physics.units import Unit
...
# delayed imports
from solving.solvers.bivariate import (
