...
from solving.polys.agca.ideals import Ideal
from solving.polys.domains.field import Field
from solving.polys.orderings import ProductOrder, monomial_key
from solving.polys.polyclasses import DMP
...
class FreeModule(Module):
    ...
    def identity_hom(self):
        ...
        [0, 1]])
        """
        from solving.polys.agca.homomorphisms import homomorphism
...
class FreeModulePolyRing(FreeModule):
    ...
    def __init__(self, ring, rank):
        from solving.polys.domains.old_polynomialring import PolynomialRingBase
...
class FreeModuleQuotientRing(FreeModule):
    ...
    def __init__(self, ring, rank):
        from solving.polys.domains.quotientring import QuotientRing
        FreeModule.__init__(self, ring, rank)
...
class SubModulePolyRing(SubModule):
    ...
    def _groebner(self, extended=False):
        ...
        from solving.polys.distributedmodules import sdm_groebner, sdm_nf_mora
    ...
    def _contains(self, x):
        from solving.polys.distributedmodules import sdm_zero, sdm_nf_mora
    ...
    def reduce_element(self, x, NF=None):
        ...
        """
        from solving.polys.distributedmodules import sdm_nf_mora
        if NF is None:
            NF = sdm_nf_mora
