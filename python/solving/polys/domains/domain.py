...
from solving.core.numbers import AlgebraicNumber
from solving.core import Basic, sympify
from solving.core.sorting import ordered
from solving.external.gmpy import GROUND_TYPES
from solving.polys.domains.domainelement import DomainElement
from solving.polys.orderings import lex
from solving.polys.polyerrors import UnificationFailed, CoercionFailed, DomainError
from solving.polys.polyutils import _unify_gens, _not_a_coeff
...
class Domain:
    ...
    def convert(self, element, base=None):
        ...
        from solving.polys.domains import ZZ, QQ, RealField, ComplexField
    ...
    def unify_composite(K0, K1):
        ...
        from solving.polys.domains.old_polynomialring import GlobalPolynomialRing
        ...
        if K0.is_ComplexField:
            if K1.is_ComplexField or K1.is_RealField:
                if K0.precision >= K1.precision:
                    ...
                    from solving.polys.domains.complexfield import ComplexField
    ...
    def frac_field(self, *symbols, order=lex):
        ...
        from solving.polys.domains.fractionfield import FractionField
        return FractionField(self, symbols, order)

    def old_poly_ring(self, *symbols, **kwargs):
        """Returns a polynomial ring, i.e. `K[X]`. """
        from solving.polys.domains.old_polynomialring import PolynomialRing
        return PolynomialRing(self, *symbols, **kwargs)

    def old_frac_field(self, *symbols, **kwargs):
        """Returns a fraction field, i.e. `K(X)`. """
        from solving.polys.domains.old_fractionfield import FractionField
