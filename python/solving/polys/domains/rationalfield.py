...
from solving.external.gmpy import MPQ

from solving.polys.domains.groundtypes import SymPyRational, is_square, sqrtrem
...
class RationalField(Field, CharacteristicZero, SimpleDomain):
    ...
    def from_sympy(self, a):
        ...
        if a.is_Rational:
            ...
            from solving.polys.domains import RR
    ...
    def algebraic_field(self, *extension, alias=None):
        ...
        *extension : One or more :py:class:`~.Expr`
        ...
        QQ<sqrt(2)>
        """
        from solving.polys.domains import AlgebraicField
