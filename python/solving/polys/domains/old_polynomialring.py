...
from solving.polys.agca.modules import FreeModulePolyRing
from solving.polys.domains.compositedomain import CompositeDomain
from solving.polys.domains.old_fractionfield import FractionField
from solving.polys.domains.ring import Ring
from solving.polys.orderings import monomial_key, build_product_order
from solving.polys.polyclasses import DMP, DMF
from solving.polys.polyerrors import (GeneratorsNeeded, PolynomialError,
        CoercionFailed, ExactQuotientFailed, NotReversible)
from solving.polys.polyutils import dict_from_basic, basic_from_dict, _dict_reorder
...
class PolynomialRingBase(Ring, CompositeDomain):
    ...
    def _sdm_to_dics(self, s, n):
        ...
        from solving.polys.distributedmodules import sdm_to_dict
        dic = sdm_to_dict(s)
...
def _vector_to_sdm_helper(v, order):
    ...
    from solving.polys.distributedmodules import sdm_from_dict
    d = {}
