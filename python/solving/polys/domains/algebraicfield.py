...
from solving.polys.domains.characteristiczero import CharacteristicZero
...
from solving.polys.polyerrors import CoercionFailed, DomainError, NotAlgebraic, IsomorphismFailed
...
class AlgebraicField(Field, CharacteristicZero, SimpleDomain):
    ...
    def __init__(self, dom, *ext, alias=None):
        ...
        *ext : One or more :py:class:`~.Expr`
        ...
        from solving.polys.numberfields import to_number_field
    ...
    def _do_round_two(self):
        from solving.polys.numberfields.basis import round_two
    ...
    def primes_above(self, p):
        ...
        from solving.polys.numberfields.primes import prime_decomp
        ZK = self.maximal_order()
