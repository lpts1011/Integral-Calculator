...
from solving.core import S, I, pi
...
from solving.core.mul import expand_2arg, Mul
from solving.core.intfunc import igcd
from solving.core.numbers import Rational, comp
from solving.core.power import Pow
from solving.core.relational import Eq
from solving.core.sorting import ordered
from solving.core.symbol import Dummy, Symbol, symbols
from solving.core.sympify import sympify
from solving.functions import exp, im, cos, acos, Piecewise
from solving.functions.elementary.miscellaneous import root, sqrt
from solving.ntheory import divisors, isprime, nextprime
from solving.polys.domains import EX
from solving.polys.polyerrors import (PolynomialError, GeneratorsNeeded,
    DomainError, UnsolvableFactorError)
from solving.polys.polyquinticconst import PolyQuintic
from solving.polys.polytools import Poly, cancel, factor, gcd_list, discriminant
from solving.polys.rationaltools import together
from solving.polys.specialpolys import cyclotomic_poly
...
def _quintic_simplify(expr):
    from solving.simplify.simplify import powsimp
    expr = powsimp(expr)
    expr = cancel(expr)
...
def roots(f, *gens,
    ...
    """
    from solving.polys.polytools import to_rational_coeffs
    flags = dict(flags)
