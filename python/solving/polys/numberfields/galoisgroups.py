...
from solving.ntheory.primetest import is_square
from solving.polys.domains import ZZ
from solving.polys.densebasic import dup_random
from solving.polys.densetools import dup_eval
from solving.polys.euclidtools import dup_discriminant
from solving.polys.factortools import dup_factor_list, dup_irreducible_p
from solving.polys.numberfields.galois_resolvents import (
    GaloisGroupException, get_resolvent_by_lookup, define_resolvents,
    Resolvent,
)
from solving.polys.numberfields.utilities import coeff_search
from solving.polys.polytools import (Poly, poly_from_expr,
                                   PolificationFailed, ComputationFailed)
from solving.polys.sqfreetools import dup_sqf_p
...
def _galois_group_degree_3(T, max_tries=30, randomize=False):
    ...
    """
    from solving.combinatorics.galois import S3TransitiveSubgroups
...
def _galois_group_degree_4_root_approx(T, max_tries=30, randomize=False):
    ...
    from solving.combinatorics.galois import S4TransitiveSubgroups
...
def _galois_group_degree_5_hybrid(T, max_tries=30, randomize=False):
    ...
    """
    from solving.combinatorics.galois import S5TransitiveSubgroups
    from solving.combinatorics.permutations import Permutation
...
def _galois_group_degree_6_lookup(T, max_tries=30, randomize=False):
    ...
    """
    from solving.combinatorics.galois import S6TransitiveSubgroups
