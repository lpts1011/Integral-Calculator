...
def define_resolvents():
    ...
    from solving.combinatorics.galois import PGL2F5
...
def get_resolvent_by_lookup(T, number):
    ...
    """
    from solving.polys.numberfields.resolvent_lookup import resolvent_coeff_lambdas
    degree = T.degree()
