...
from solving.core.exprtools import Factors
from solving.core.function import expand_mul, expand_multinomial, _mexpand
from solving.core.mul import Mul
from solving.core.numbers import (I, Rational, pi, _illegal)
...
from solving.functions.elementary.miscellaneous import sqrt, cbrt
from solving.functions.elementary.trigonometric import cos, sin, tan
from solving.ntheory.factor_ import divisors
from solving.utilities.iterables import subsets

from solving.polys.domains import ZZ, QQ, FractionField
from solving.polys.orthopolys import dup_chebyshevt
from solving.polys.polyerrors import (
    NotAlgebraic,
    GeneratorsError,
)
from solving.polys.polytools import (
    Poly, PurePoly, invert, factor_list, groebner, resultant,
    degree, poly_from_expr, parallel_poly_from_expr, lcm
)
from solving.polys.polyutils import dict_from_expr, expr_from_dict
from solving.polys.ring_series import rs_compose_add
from solving.polys.rings import ring
from solving.polys.rootoftools import CRootOf
from solving.polys.specialpolys import cyclotomic_poly
from solving.utilities import (
...
def _separate_sq(p):
    ...
    for i in range(len(surds)):
        if surds[i] != 1:
            break
    from solving.simplify.radsimp import _split_gcd
