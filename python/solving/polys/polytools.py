...
from solving.core import (
    S, Expr, Add, Tuple
)
from solving.core.basic import Basic
from solving.core.decorators import _sympifyit
from solving.core.exprtools import Factors, factor_nc, factor_terms
from solving.core.evalf import (
    pure_complex, evalf, fastlog, _evalf_with_bounded_error, quad_to_mpmath)
from solving.core.function import Derivative
from solving.core.mul import Mul, _keep_coeff
from solving.core.intfunc import ilcm
from solving.core.numbers import I, Integer, equal_valued
from solving.core.relational import Relational, Equality
from solving.core.sorting import ordered
from solving.core.symbol import Dummy, Symbol
from solving.core.sympify import sympify, _sympify
from solving.core.traversal import preorder_traversal, bottom_up
from solving.logic.boolalg import BooleanAtom
from solving.polys import polyoptions as options
from solving.polys.constructor import construct_domain
from solving.polys.domains import FF, QQ, ZZ
from solving.polys.domains.domainelement import DomainElement
from solving.polys.fglmtools import matrix_fglm
from solving.polys.groebnertools import groebner as _groebner
from solving.polys.monomials import Monomial
from solving.polys.orderings import monomial_key
from solving.polys.polyclasses import DMP, DMF, ANP
from solving.polys.polyerrors import (
...
from solving.polys.polyutils import (
    basic_from_dict,
    _sort_gens,
    _unify_gens,
    _dict_reorder,
...
from solving.utilities import group, public, filldedent
from solving.utilities.exceptions import sympy_deprecation_warning
from solving.utilities.iterables import iterable, sift

# Required to avoid errors
import solving.polys
...
class Poly(Basic):
    ...
    def dispersionset(f, g=None):
        ...
        4. [Man93]_
        """
        from solving.polys.dispersion import dispersionset
    ...
    def dispersion(f, g=None):
        ...
        4. [Man93]_
        """
        from solving.polys.dispersion import dispersion
    ...
    def root(f, index, radicals=True):
        ...
        """
        return solving.polys.rootoftools.rootof(f, index, radicals=radicals)
    ...
    def real_roots(f, multiple=True, radicals=True):
        ...
        [CRootOf(x**3 + x + 1, 0)]
        """
        reals = solving.polys.rootoftools.CRootOf.real_roots(f, radicals=radicals)
    ...
    def all_roots(f, multiple=True, radicals=True):
        ...
        """
        roots = solving.polys.rootoftools.CRootOf.all_roots(f, radicals=radicals)
    ...
    def nroots(f, n=15, maxsteps=50, cleanup=True):
        ...
        from solving.functions.elementary.complexes import sign
        try:
    ...
    def galois_group(f, by_name=False, max_tries=30, randomize=False):
        ...
        """
        from solving.polys.numberfields.galoisgroups import (
        ...
        if n > max_supported:
            ...
            from solving.combinatorics.galois import S1TransitiveSubgroups
            name, alt = S1TransitiveSubgroups.S1, True
        elif n == 2:
            from solving.combinatorics.galois import S2TransitiveSubgroups
...
def cancel(f, *gens, _signsimp=True, **args):
    ...
    from solving.polys.rings import sring
    options.allowed_flags(args, ['polys'])
...
def reduced(f, G, *gens, **args):
    ...
    from solving.polys.rings import xring
...
class GroebnerBasis(Basic):
    ...
    def __new__(cls, F, *gens, **args):
        ...
        from solving.polys.rings import PolyRing
