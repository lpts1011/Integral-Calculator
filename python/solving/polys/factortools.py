...
from solving.polys.densebasic import (
...
from solving.polys.densearith import (
    dup_neg, dmp_neg,
    dup_add, dmp_add,
    dup_sub, dmp_sub,
    dup_mul, dmp_mul,
...
from solving.polys.densetools import (
...
from solving.polys.euclidtools import (
    dmp_primitive,
...
from solving.polys.polyutils import _sort_factors
from solving.polys.polyconfig import query

from solving.polys.polyerrors import (
    ExtraneousFactors, DomainError, CoercionFailed, EvaluationFailed)

from solving.utilities import subsets
...
def dup_zz_zassenhaus(f, K):
    ...
    from solving.ntheory import isprime
...
def dmp_zz_wang(f, u, K, mod=None, seed=None):
    ...
    """
    from solving.ntheory import nextprime
