...
from solving.core import S, Basic, symbols, Dummy
from solving.polys.polyerrors import (
    PolificationFailed, ComputationFailed,
    MultivariatePolynomialError, OptionError)
from solving.polys.polyoptions import allowed_flags, build_options
from solving.polys.polytools import poly_from_expr, Poly
from solving.polys.specialpolys import (
    symmetric_poly, interpolating_poly)
from solving.polys.rings import sring
from solving.utilities import numbered_symbols, take, public
...
def rational_interpolate(data, degnum, X=symbols('x')):
    ...
    """
    from solving.matrices.dense import ones
