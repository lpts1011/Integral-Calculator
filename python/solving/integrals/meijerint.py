...
from solving.core import S, Expr
...
from solving.core.function import (expand, expand_mul, expand_power_base,
...
from solving.core.relational import Eq, Ne, _canonical_coeff
from solving.core.sorting import default_sort_key, ordered
from solving.core.symbol import Dummy, symbols, Wild, Symbol
from solving.core.sympify import sympify
from solving.functions.combinatorial.factorials import factorial
from solving.functions.elementary.complexes import (re, im, arg, Abs, sign,
        unpolarify, polarify, polar_lift, principal_branch, unbranched_argument,
        periodic_argument)
from solving.functions.elementary.exponential import exp, exp_polar, log
...
from solving.functions.elementary.trigonometric import (cos, sin, sinc,
...
from solving.functions.special.elliptic_integrals import elliptic_k, elliptic_e
from solving.functions.special.error_functions import (erf, erfc, erfi, Ei,
        expint, Si, Ci, Shi, Chi, fresnels, fresnelc)
from solving.functions.special.gamma_functions import gamma
from solving.functions.special.hyper import hyper, meijerg
from solving.functions.special.singularity_functions import SingularityFunction
from .integrals import Integral
from solving.logic.boolalg import And, Or, BooleanAtom, Not, BooleanFunction
from solving.polys import cancel, factor
from solving.utilities.iterables import multiset_partitions
from solving.utilities.misc import debug as _debug
from solving.utilities.misc import debugf as _debugf
...
from solving.utilities.timeutils import timethis
...
def _get_coeff_exp(expr, x):
    ...
    (1, 3)
    """
    from solving.simplify import powsimp
...
def _int0oo_1(g, x):
    ...
    """
    from solving.simplify import gammasimp
    # See [L, section 5.6.1]. Note that s=1.
    eta, _ = _get_coeff_exp(g.argument, x)
    res = 1/eta
...
def _rewrite_saxena(fac, po, g1, g2, x, full_pb=False):
    ...
    from solving.simplify import powdenest
...
def _rewrite_single(f, x, recursive=True):
    ...
    def my_imt(F, s, x, strip):
        ...
        try:
            ...
            from solving.simplify import simplify
    ...
    def my_integrator(f, x):
        ...
        if r is not None:
            from solving.simplify import hyperexpand
            res, cond = r
...
def _meijerint_indefinite_1(f, x):
    ...
    from solving.simplify import hyperexpand, powdenest
...
def _guess_expansion(f, x):
    ...
    if orig.has(cos, sin):
        from solving.simplify.fu import sincos_to_sum
