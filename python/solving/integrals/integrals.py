...
from solving.concrete.expr_with_limits import AddWithLimits
...
from solving.core.logic import fuzzy_bool
from solving.core.mul import Mul
from solving.core.numbers import oo, pi
from solving.core.relational import Ne
from solving.core.singleton import S
from solving.core.symbol import (Dummy, Symbol, Wild)
from solving.core.sympify import sympify
from solving.functions import Piecewise, sqrt, piecewise_fold, tan, cot, atan
from solving.functions.elementary.exponential import log
from solving.functions.elementary.integers import floor
from solving.functions.elementary.complexes import Abs, sign
from solving.functions.elementary.miscellaneous import Min, Max
from solving.functions.special.singularity_functions import Heaviside
from .rationaltools import ratint
from solving.matrices import MatrixBase
from solving.polys import Poly, PolynomialError
from solving.series.formal import FormalPowerSeries
from solving.series.limits import limit
from solving.series.order import Order
from solving.tensor.functions import shape
from solving.utilities.exceptions import sympy_deprecation_warning
from solving.utilities.iterables import is_sequence
...
class Integral(AddWithLimits):
    ...
    def transform(self, x, u):
        ...
        if not x.is_Symbol:
            ...
            f = [u.subs(uvar, d)]
            from solving.simplify.simplify import posify
    ...
    def _eval_integral(self, f, x, meijerg=None, risch=None, manual=None,
        ...
        from solving.integrals.risch import risch_integrate, NonElementaryIntegral
        from solving.integrals.manualintegrate import manualintegrate
        ...
        for g in args:
            ...
            if not (manual or meijerg or risch):
                ...
                if heurisch is not False:
                    from solving.integrals.heurisch import (heurisch as heurisch_,
                                                          heurisch_wrapper)
                    try:
                        if conds == 'piecewise':
    ...
    def principal_value(self, **kwargs):
        ...
        from solving.calculus.singularities import singularities
...
def line_integrate(field, curve, vars):
    ...
    """
    from solving.geometry import Curve
    F = sympify(field)
    if not F:
        raise ValueError(
