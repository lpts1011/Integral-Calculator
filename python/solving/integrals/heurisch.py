...
from solving.core.symbol import Wild, Dummy, Symbol
from solving.core.basic import sympify
from solving.core.numbers import Rational, pi, I
from solving.core.relational import Eq, Ne
from solving.core.singleton import S
from solving.core.sorting import ordered
from solving.core.traversal import iterfreeargs

from solving.functions import exp, sin, cos, tan, cot, asin, atan
from solving.functions import log, sinh, cosh, tanh, coth, asinh
from solving.functions import sqrt, erf, erfi, li, Ei
from solving.functions import besselj, bessely, besseli, besselk
from solving.functions import hankel1, hankel2, jn, yn
from solving.functions.elementary.complexes import Abs, re, im, sign, arg
from solving.functions.elementary.exponential import LambertW
from solving.functions.elementary.integers import floor, ceiling
...
from solving.logic.boolalg import And, Or
from solving.utilities.iterables import uniq

from solving.polys import quo, gcd, lcm, factor_list, cancel, PolynomialError
from solving.polys.monomials import itermonomials
from solving.polys.polyroots import root_factors

from solving.polys.rings import PolyRing
from solving.polys.solvers import solve_lin_sys
...
def heurisch_wrapper(f, x, rewrite=False, hints=None, mappings=None, retries=3,
    ...
    heurisch
    """
    from solving.solvers.solvers import solve, denoms
    f = sympify(f)
    if not f.has_free(x):
        return f*x
