...
import sys
import solving
from solving.core import S, pi, I
from solving.core.add import Add
from solving.core.cache import cacheit
from solving.core.expr import Expr
from solving.core.function import (
    AppliedUndef, Derivative, expand, expand_complex, expand_mul, expand_trig,
    Lambda, WildFunction, diff, Subs)
from solving.core.mul import Mul, prod
from solving.core.relational import (
    _canonical, Ge, Gt, Lt, Unequality, Eq, Ne, Relational)
from solving.core.sorting import ordered
from solving.core.symbol import Dummy, symbols, Wild
from solving.functions.elementary.complexes import (
    re, im, arg, Abs, polar_lift, periodic_argument)
from solving.functions.elementary.exponential import exp, log
from solving.functions.elementary.hyperbolic import cosh, coth, sinh, asinh
from solving.functions.elementary.miscellaneous import Max, Min, sqrt
from solving.functions.elementary.piecewise import (
    Piecewise, piecewise_exclusive)
from solving.functions.elementary.trigonometric import cos, sin, atan, sinc
from solving.functions.special.bessel import besseli, besselj, besselk, bessely
from solving.functions.special.delta_functions import DiracDelta, Heaviside
from solving.functions.special.error_functions import erf, erfc, Ei
from solving.functions.special.gamma_functions import (
    digamma, gamma, lowergamma, uppergamma)
from solving.functions.special.singularity_functions import SingularityFunction
from solving.integrals import integrate, Integral
from solving.integrals.transforms import (
    _simplify, IntegralTransform, IntegralTransformError)
from solving.logic.boolalg import to_cnf, conjuncts, disjuncts, Or, And
from solving.matrices.matrixbase import MatrixBase
from solving.polys.matrices.linsolve import _lin_eq2dict
from solving.polys.polyerrors import PolynomialError
from solving.polys.polyroots import roots
from solving.polys.polytools import Poly
from solving.polys.rationaltools import together
from solving.polys.rootoftools import RootSum
from solving.utilities.exceptions import (
    sympy_deprecation_warning, SymPyDeprecationWarning, ignore_warnings)
from solving.utilities.misc import debugf
...
def DEBUG_WRAP(func):
    def wrap(*args, **kwargs):
        from solving import SOLVING_DEBUG
        global _LT_level

        if not SOLVING_DEBUG:
        ...
        if (
            ...
            solving.SOLVING_DEBUG = False
            print('**** %sIntegrating ...' % ('  '*_LT_level), file=sys.stderr)
            result = func(*args, **kwargs)
            solving.SOLVING_DEBUG = True
        else:
            result = func(*args, **kwargs)
        _LT_level -= 1
...
def _simplifyconds(expr, s, a):
    ...
    from solving.simplify.radsimp import collect_abs
...
def _laplace_transform_integration(f, t, s_, *, simplify):
    ...
    def process_conds(conds):
        ...
        from solving.solvers.inequalities import _solve_inequality
...
def laplace_transform(f, t, s, legacy_matrix=True, **hints):
    ...
    debug information on by setting ``sympy.SOLVING_DEBUG=True``. The numbers
...
def _inverse_laplace_transform_integration(F, s, t_, plane, *, simplify):
    ...
    from solving.integrals.meijerint import meijerint_inversion, _get_coeff_exp
    from solving.integrals.transforms import inverse_mellin_transform
