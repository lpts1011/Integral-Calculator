...
from solving.functions.elementary.hyperbolic import (cosh, coth, sinh,
    tanh)
from solving.functions.elementary.piecewise import Piecewise
from solving.functions.elementary.trigonometric import (atan, sin, cos,
    tan, acot, cot, asin, acos)
from .integrals import integrate, Integral
from .heurisch import _symbols
from solving.polys.polyerrors import PolynomialError
from solving.polys.polytools import (real_roots, cancel, Poly, gcd,
    reduced)
...
def integrate_hyperexponential_polynomial(p, DE, z):
    ...
    from solving.integrals.rde import rischDE
