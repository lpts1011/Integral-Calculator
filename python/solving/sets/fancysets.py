...
from solving.core.logic import fuzzy_not, fuzzy_or, fuzzy_and
from solving.core.mod import Mod
from solving.core.intfunc import igcd
from solving.core.numbers import oo, Rational, Integer
from solving.core.relational import Eq, is_eq
from solving.core.kind import NumberKind
from solving.core.singleton import Singleton, S
from solving.core.symbol import Dummy, symbols, Symbol
...
class ImageSet(Set):
    ...
    def _contains(self, other):
        from solving.solvers.solveset import _solveset_multi
...
def normalize_theta_set(theta):
    ...
    """
    from solving.functions.elementary.trigonometric import _pi_coeff
...
class ComplexRegion(Set):
    ...
    * c2 represents the region in complex plane inside the
    ...
    def _contains(self, other):
        from solving.functions import arg, Abs
