from solving.core.basic import _aresame
from solving.core.function import Lambda, expand_complex
from solving.core.mul import Mul
from solving.core.numbers import ilcm, Float
from solving.core.relational import Eq
from solving.core.singleton import S
from solving.core.symbol import (Dummy, symbols)
...
from solving.sets.fancysets import ComplexRegion
from solving.sets.sets import (FiniteSet, Intersection, Interval, Set, Union)
from solving.multipledispatch import Dispatcher
from solving.sets.conditionset import ConditionSet
from solving.sets.fancysets import (Integers, Naturals, Reals, Range,
    ImageSet, Rationals)
from solving.sets.sets import EmptySet, UniversalSet, imageset, ProductSet
from solving.simplify.radsimp import numer
...
def _(a, b):
    ...
    from solving.solvers.diophantine.diophantine import diop_linear
...
def _(self, other):
    from solving.solvers.diophantine import diophantine
    ...
    if other == S.Reals:
        from solving.solvers.solvers import denoms, solve_linear
        ...
        from solving.solvers.solveset import (invert_real, invert_complex,
                                            solveset)
