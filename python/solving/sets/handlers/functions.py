...
from solving.core import Expr, Add
from solving.core.function import Lambda, FunctionClass, diff, expand_mul
from solving.core.numbers import Float, oo
...
from solving.sets import (imageset, Interval, FiniteSet, Union, ImageSet,
    Intersection, Range, Complement)
from solving.sets.sets import EmptySet, is_function_invertible_in_set
from solving.sets.fancysets import Integers, Naturals, Reals
from solving.functions.elementary.exponential import match_real_imag
...
def _(f, x):
    ...
    from solving.series import limit
    ...
    try:
        from solving.polys.polyutils import _nsort
