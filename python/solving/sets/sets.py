...
from solving.core.kind import Kind, UndefinedKind, NumberKind
from solving.core.basic import Basic
from solving.core.containers import Tuple, TupleKind
from solving.core.decorators import sympify_method_args, sympify_return
from solving.core.evalf import EvalfMixin
from solving.core.expr import Expr
from solving.core.function import Lambda
from solving.core.logic import (FuzzyBool, fuzzy_bool, fuzzy_or, fuzzy_and,
    fuzzy_not)
from solving.core.numbers import Float, Integer
from solving.core.operations import LatticeOp
from solving.core.parameters import global_parameters
from solving.core.relational import Eq, Ne, is_lt
from solving.core.singleton import Singleton, S
from solving.core.sorting import ordered
from solving.core.symbol import symbols, Symbol, Dummy, uniquely_named_symbol
from solving.core.sympify import _sympify, sympify, _sympy_converter
from solving.functions.elementary.exponential import exp, log
from solving.functions.elementary.miscellaneous import Max, Min
from solving.logic.boolalg import And, Or, Not, Xor, true, false
from solving.utilities.decorator import deprecated
from solving.utilities.exceptions import sympy_deprecation_warning
from solving.utilities.iterables import (iproduct, sift, roundrobin, iterable,
                                       subsets)
from solving.utilities.misc import func_name, filldedent
...
class Set(Basic, EvalfMixin):
    ...
    def is_subset(self, other):
        ...
        from solving.sets.handlers.issubset import is_subset_sets
...
def simplify_union(args):
    ...
    """
    from solving.sets.handlers.union import union_sets
...
def simplify_intersection(args):
    ...
    from solving.sets.handlers.intersection import intersection_sets
...
def set_add(x, y):
    from solving.sets.handlers.add import _set_add
    return _apply_operation(_set_add, x, y, commutative=True)


def set_sub(x, y):
    from solving.sets.handlers.add import _set_sub
    return _apply_operation(_set_sub, x, y, commutative=False)


def set_mul(x, y):
    from solving.sets.handlers.mul import _set_mul
    return _apply_operation(_set_mul, x, y, commutative=True)


def set_div(x, y):
    from solving.sets.handlers.mul import _set_div
    return _apply_operation(_set_div, x, y, commutative=False)


def set_pow(x, y):
    from solving.sets.handlers.power import _set_pow
    return _apply_operation(_set_pow, x, y, commutative=False)


def set_function(f, x):
    from solving.sets.handlers.functions import _set_function
