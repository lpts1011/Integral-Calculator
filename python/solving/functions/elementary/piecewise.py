from solving.core import S, diff, Tuple, Dummy, Mul
from solving.core.basic import Basic, as_Basic
from solving.core.function import DefinedFunction
from solving.core.numbers import Rational, NumberSymbol, _illegal
from solving.core.parameters import global_parameters
from solving.core.relational import (Lt, Gt, Eq, Ne, Relational,
    _canonical, _canonical_coeff)
from solving.core.sorting import ordered
from solving.functions.elementary.miscellaneous import Max, Min
from solving.logic.boolalg import (And, Boolean, distribute_and_over_or, Not,
    true, false, Or, ITE, simplify_logic, to_cnf, distribute_or_over_and)
from solving.utilities.iterables import uniq, sift, common_prefix
from solving.utilities.misc import filldedent, func_name
        ...
        if irel:
            ...
            for truth in product((1, 0), repeat=len(irel)):
                ...
                if 1 not in truth:
                    ...
                    if len(free) == 1:
                        from solving.solvers.inequalities import (
