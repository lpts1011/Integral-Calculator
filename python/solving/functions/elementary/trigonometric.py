...
from solving.core.function import DefinedFunction, ArgumentIndexError, PoleError, expand_mul
from solving.core.logic import fuzzy_not, fuzzy_or, FuzzyBool, fuzzy_and
from solving.core.mod import Mod
from solving.core.numbers import Rational, pi, Integer, Float, equal_valued
from solving.core.relational import Ne, Eq
from solving.core.singleton import S
from solving.core.symbol import Symbol, Dummy
from solving.core.sympify import sympify
from solving.functions.combinatorial.factorials import factorial, RisingFactorial
from solving.functions.combinatorial.numbers import bernoulli, euler
from solving.functions.elementary.complexes import arg as arg_f, im, re
from solving.functions.elementary.exponential import log, exp
from solving.functions.elementary.integers import floor
from solving.functions.elementary.miscellaneous import sqrt, Min, Max
from solving.functions.elementary.piecewise import Piecewise
from solving.functions.elementary._trigonometric_special import (
    cos_table, ipartfrac, fermat_coords)
from solving.logic.boolalg import And
from solving.ntheory import factorint
from solving.polys.specialpolys import symmetric_poly
from solving.utilities.iterables import numbered_symbols
...
class sin(TrigonometricFunction):
    ...
    def eval(cls, arg):
        ...
        from solving.sets.setexpr import SetExpr
        if arg.is_Number:
            if arg is S.NaN:
                return S.NaN
            elif arg.is_zero:
        ...
        if isinstance(arg, AccumBounds):
            from solving.sets.sets import FiniteSet
        ...
        if i_coeff is not None:
            from solving.functions.elementary.hyperbolic import sinh
    ...
    def _eval_rewrite_as_besselj(self, arg, **kwargs):
        from solving.functions.special.bessel import besselj
    ...
    def as_real_imag(self, deep=True, **hints):
        from solving.functions.elementary.hyperbolic import cosh, sinh
        re, im = self._as_real_imag(deep=deep, **hints)
        return (sin(re)*cosh(im), cos(re)*sinh(im))

    def _eval_expand_trig(self, **hints):
        from solving.functions.special.polynomials import chebyshevt, chebyshevu
        arg = self.args[0]
        x = None
...
class cos(TrigonometricFunction):
    ...
    @classmethod
    def eval(cls, arg):
        from solving.functions.special.polynomials import chebyshevt
        from solving.calculus.accumulationbounds import AccumBounds
        from solving.sets.setexpr import SetExpr
        if arg.is_Number:
            if arg is S.NaN:
        ...
        i_coeff = _imaginary_unit_as_coefficient(arg)
        if i_coeff is not None:
            from solving.functions.elementary.hyperbolic import cosh
            return cosh(i_coeff)
...
class tan(TrigonometricFunction):
    ...
    def _eval_as_leading_term(self, x, logx, cdir):
        from solving.calculus.accumulationbounds import AccumBounds
        from solving.functions.elementary.complexes import re
        arg = self.args[0]
        x0 = arg.subs(x, 0).cancel()
        n = 2*x0/pi
        if n.is_integer:
...
class cot(TrigonometricFunction):
    ...
    def eval(cls, arg):
        ...
        i_coeff = _imaginary_unit_as_coefficient(arg)
        if i_coeff is not None:
            from solving.functions.elementary.hyperbolic import coth
...
class sinc(DefinedFunction):
    ...
    * As zero'th order spherical Bessel Function
    ...
    def _eval_rewrite_as_jn(self, arg, **kwargs):
        from solving.functions.special.bessel import jn
        return jn(0, arg)
...
class asin(InverseTrigonometricFunction):
    ...
    def eval(cls, arg):
        ...
        i_coeff = _imaginary_unit_as_coefficient(arg)
        if i_coeff is not None:
            from solving.functions.elementary.hyperbolic import asinh
    ...
    def _eval_nseries(self, x, n, logx, cdir=0):  # asin
        from solving.series.order import O
...
class atan(InverseTrigonometricFunction):
    ...
    def eval(cls, arg):
        ...
        i_coeff = _imaginary_unit_as_coefficient(arg)
        if i_coeff is not None:
            from solving.functions.elementary.hyperbolic import atanh
...
class acot(InverseTrigonometricFunction):
    ...
    def eval(cls, arg):
        ...
        i_coeff = _imaginary_unit_as_coefficient(arg)
        if i_coeff is not None:
            from solving.functions.elementary.hyperbolic import acoth
...
class atan2(InverseTrigonometricFunction):
    ...
    @classmethod
    def eval(cls, y, x):
        from solving.functions.special.delta_functions import Heaviside
