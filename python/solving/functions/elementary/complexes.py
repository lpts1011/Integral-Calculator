...
from solving.core import S, Add, Mul, sympify, Symbol, Dummy, Basic
from solving.core.expr import Expr
from solving.core.exprtools import factor_terms
from solving.core.function import (DefinedFunction, Derivative, ArgumentIndexError,
    AppliedUndef, expand_mul, PoleError)
from solving.core.logic import fuzzy_not, fuzzy_or
from solving.core.numbers import pi, I, oo
...
class arg(DefinedFunction):
    ...
    def eval(cls, arg):
        ...
        if any(i.is_extended_positive is None for i in arg_.atoms(AppliedUndef)):
            return
        from solving.functions.elementary.trigonometric import atan2
...
class adjoint(DefinedFunction):
    ...
    def _pretty(self, printer, *args):
        from solving.printing.pretty.stringpict import prettyForm
...
class polar_lift(DefinedFunction):
    ...
    @classmethod
    def eval(cls, arg):
        from solving.functions.elementary.complexes import arg as argument
        if arg.is_number:
            ar = argument(arg)
...
class periodic_argument(DefinedFunction):
    ...
    def _getunbranched(cls, ar):
        from solving.functions.elementary.exponential import exp_polar, log
        if ar.is_Mul:
            args = ar.args
        else:
            args = [ar]
    ...
    def eval(cls, ar, period):
        ...
        if unbranched is None:
            return None
        from solving.functions.elementary.trigonometric import atan, atan2
