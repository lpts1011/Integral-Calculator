...
from solving.core.function import (DefinedFunction, ArgumentIndexError, expand_log,
    expand_mul, FunctionClass, PoleError, expand_multinomial, expand_complex)
from solving.core.logic import fuzzy_and, fuzzy_not, fuzzy_or
from solving.core.mul import Mul
from solving.core.numbers import Integer, Rational, pi, I
...
from solving.core.symbol import Wild, Dummy
from solving.core.sympify import sympify
from solving.functions.combinatorial.factorials import factorial
from solving.functions.elementary.complexes import arg, unpolarify, im, re, Abs
from solving.functions.elementary.miscellaneous import sqrt
from solving.ntheory import multiplicity, perfect_power
from solving.ntheory.factor_ import factorint
...
class exp(ExpBase, metaclass=ExpMeta):
    ...
    def _eval_refine(self, assumptions):
        from solving.assumptions import ask, Q
        arg = self.args[0]
        if arg.is_Mul:
            Ioo = I*S.Infinity
            if arg in [Ioo, -Ioo]:
    ...
    @classmethod
    def eval(cls, arg):
        from solving.calculus import AccumBounds
    ...
    def as_real_imag(self, deep=True, **hints):
        ...
        """
        from solving.functions.elementary.trigonometric import cos, sin
    ...
    def _eval_as_leading_term(self, x, logx, cdir):
        from solving.calculus.util import AccumBounds
...
class log(DefinedFunction):
        ...
        if arg.is_number and arg.is_algebraic:
            ...
            if coeff.is_real and i_ and i_.is_real and r_.is_real:
                if r_.is_zero:
                    ...
                    from solving.simplify import ratsimp
    ...
    def _eval_expand_log(self, deep=True, **hints):
        from solving.concrete import Sum, Product
    ...
    def _eval_simplify(self, **kwargs):
        from solving.simplify.simplify import expand_log, simplify, inversecombine
