...
from solving.core import EulerGamma # Must be imported from core, not core.numbers
from solving.core.add import Add
from solving.core.cache import cacheit
from solving.core.function import DefinedFunction, ArgumentIndexError, expand_mul
from solving.core.logic import fuzzy_or
from solving.core.numbers import I, pi, Rational, Integer
from solving.core.relational import is_eq
...
from solving.functions.combinatorial.factorials import factorial, factorial2, RisingFactorial
from solving.functions.elementary.complexes import  polar_lift, re, unpolarify
from solving.functions.elementary.integers import ceiling, floor
from solving.functions.elementary.miscellaneous import sqrt, root
from solving.functions.elementary.exponential import exp, log, exp_polar
...
class expint(DefinedFunction):
    ...
    @classmethod
    def eval(cls, nu, z):
        from solving.functions.special.gamma_functions import (gamma, uppergamma)
        nu2 = unpolarify(nu)
        if nu != nu2:
            return expint(nu2, z)
