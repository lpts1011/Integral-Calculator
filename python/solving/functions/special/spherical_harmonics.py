...
from solving.core.numbers import I, pi
from solving.core.singleton import S
from solving.core.symbol import Dummy
from solving.functions import assoc_legendre
from solving.functions.combinatorial.factorials import factorial
from solving.functions.elementary.complexes import Abs, conjugate
...
class Ynm(DefinedFunction):
    ...
    def _eval_rewrite_as_cos(self, n, m, theta, phi, **kwargs):
        ...
        from solving.simplify import simplify, trigsimp
        # TODO: Make sure n \in N
        # TODO: Assert |m| <= n ortherwise we should return 0
