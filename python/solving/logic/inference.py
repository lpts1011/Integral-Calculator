...
from solving.logic.boolalg import And, Not, conjuncts, to_cnf, BooleanFunction
from solving.core.sorting import ordered
from solving.core.sympify import sympify
from solving.external.importtools import import_module
...
def satisfiable(expr, algorithm=None, all_models=False, minimal=False, use_lra_theory=False):
    ...
    if algorithm == "dpll":
        from solving.logic.algorithms.dpll import dpll_satisfiable
        return dpll_satisfiable(expr)
    elif algorithm == "dpll2":
        from solving.logic.algorithms.dpll2 import dpll_satisfiable
        return dpll_satisfiable(expr, all_models, use_lra_theory=use_lra_theory)
    elif algorithm == "pycosat":
        from solving.logic.algorithms.pycosat_wrapper import pycosat_satisfiable
        return pycosat_satisfiable(expr, all_models)
    elif algorithm == "minisat22":
        from solving.logic.algorithms.minisat22_wrapper import minisat22_satisfiable
        return minisat22_satisfiable(expr, all_models, minimal)
    elif algorithm == "z3":
        from solving.logic.algorithms.z3_wrapper import z3_satisfiable
