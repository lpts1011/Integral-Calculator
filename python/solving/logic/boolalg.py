...
from solving.core.function import Application, Derivative
from solving.core.kind import BooleanKind, NumberKind
from solving.core.numbers import Number
...
from solving.core.sympify import _sympy_converter, _sympify, sympify
from solving.utilities.iterables import sift, ibin
...
class Boolean(Basic):
    ...
    def equals(self, other):
        ...
        """
        from solving.logic.inference import satisfiable
    ...
    def as_set(self):
        ...
        """
        from solving.calculus.util import periodicity
        from solving.core.relational import Relational
    ...
    def _eval_refine(self, assumptions):
        from solving.assumptions import ask
...
class And(LatticeOp, BooleanFunction):
    ...
    def _eval_simplify(self, **kwargs):
        from solving.core.relational import Equality, Relational
        from solving.solvers.solveset import linear_coeffs
        # standard simplify
    ...
    def _eval_as_set(self):
        from solving.sets.sets import Intersection
...
class Or(LatticeOp, BooleanFunction):
    ...
    def _eval_as_set(self):
        from solving.sets.sets import Union
    ...
    def _eval_simplify(self, **kwargs):
        from solving.core.relational import Le, Ge, Eq
...
def is_literal(expr):
    ...
    """
    from solving.assumptions import AppliedPredicate
...
def _apply_patternbased_simplification(rv, patterns, measure,
    ...
    """
    from solving.core.relational import Relational, _canonical
...
def _apply_patternbased_twoterm_simplification(Rel, patterns, func,
    ...
    from solving.core.relational import Ge, Gt, _Inequality
    changed = True
...
def _apply_patternbased_threeterm_simplification(Rel, patterns, func,
    ...
    from solving.functions.elementary.miscellaneous import Min, Max
    from solving.core.relational import Le, Lt, _Inequality
    changed = True
...
def _simplify_patterns_and():
    ...
    from solving.core import Wild
    from solving.core.relational import Eq, Ne, Ge, Gt, Le, Lt
...
def _simplify_patterns_and3():
    ...
    from solving.core import Wild
    from solving.core.relational import Eq, Ge, Gt
