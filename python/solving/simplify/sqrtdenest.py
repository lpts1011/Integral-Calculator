from solving.core import Add, Expr, Mul, S, sympify
from solving.core.function import _mexpand, count_ops, expand_mul
from solving.core.sorting import default_sort_key
from solving.core.symbol import Dummy
from solving.functions import root, sign, sqrt
...
def _sqrt_match(p):
    ...
    """
    from solving.simplify.radsimp import split_surds
...
def _sqrtdenest_rec(expr):
    ...
    """
    from solving.simplify.radsimp import radsimp, rad_rationalize, split_surds
    if not expr.is_Pow:
...
def _sqrtdenest1(expr, denester=True):
    ...
    from solving.simplify.simplify import radsimp
...
def sqrt_biquadratic_denest(expr, a, b, r, d2):
    ...
    """
    from solving.simplify.radsimp import radsimp, rad_rationalize
