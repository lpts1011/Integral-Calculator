...
from solving.core import (sympify, Basic, S, Expr, factor_terms,
                        Mul, Add, bottom_up)
from solving.core.cache import cacheit
from solving.core.function import (count_ops, _mexpand, FunctionClass, expand,
                                 expand_mul, _coeff_isneg, Derivative)
from solving.core.numbers import I, Integer
from solving.core.intfunc import igcd
from solving.core.sorting import _nodes
from solving.core.symbol import Dummy, symbols, Wild
from solving.external.gmpy import SYMPY_INTS
from solving.functions import sin, cos, exp, cosh, tanh, sinh, tan, cot, coth
from solving.functions import atan2
...
from solving.polys import Poly, factor, cancel, parallel_poly_from_expr
from solving.polys.domains import ZZ
from solving.polys.polyerrors import PolificationFailed
from solving.polys.polytools import groebner
from solving.simplify.cse_main import cse
from solving.strategies.core import identity
from solving.strategies.tree import greedy
...
def trigsimp_groebner(expr, hints=[], quick=False, order="grlex",
    ...
    from solving.simplify.ratsimp import ratsimpmodprime
...
def trigsimp(expr, inverse=False, **opts):
    ...
    """
    from solving.simplify.fu import fu
...
def exptrigsimp(expr):
    ...
    exp(-z)
    """
    from solving.simplify.fu import hyper_as_trig, TR2i
...
def trigsimp_old(expr, *, first=True, **opts):
    ...
    if first:
        ...
        if len(trigsyms) > 1:
            from solving.simplify.simplify import separatevars
...
def __trigsimp(expr, deep=False):
    ...
    from solving.simplify.fu import TR10i
...
def futrig(e, *, hyper=True, **kwargs):
    ...
    """
    from solving.simplify.fu import hyper_as_trig
...
def _futrig(e):
    """Helper for futrig."""
    from solving.simplify.fu import (
