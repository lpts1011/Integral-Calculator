...
from solving.core import (Basic, S, Add, Mul, Pow, Symbol, sympify,
                        expand_func, Function, Dummy, Expr, factor_terms,
                        expand_power_exp, Eq)
from solving.core.exprtools import factor_nc
from solving.core.parameters import global_parameters
from solving.core.function import (expand_log, count_ops, _mexpand,
    nfloat, expand_mul, expand)
from solving.core.numbers import Float, I, pi, Rational, equal_valued
from solving.core.relational import Relational
from solving.core.rules import Transform
from solving.core.sorting import ordered
from solving.core.sympify import _sympify
from solving.core.traversal import bottom_up as _bottom_up, walk as _walk
from solving.functions import gamma, exp, sqrt, log, exp_polar, re
from solving.functions.combinatorial.factorials import CombinatorialFunction
from solving.functions.elementary.complexes import unpolarify, Abs, sign
from solving.functions.elementary.exponential import ExpBase
...
from solving.functions.special.bessel import (BesselBase, besselj, besseli,
                                            besselk, bessely, jn)
from solving.functions.special.tensor_functions import KroneckerDelta
from solving.integrals.integrals import Integral
from solving.logic.boolalg import Boolean
from solving.matrices.expressions import (MatrixExpr, MatAdd, MatMul,
                                            MatPow, MatrixSymbol)
from solving.polys import together, cancel, factor
from solving.polys.numberfields.minpoly import _is_sum_surds, _minimal_polynomial_sq
from solving.sets.sets import Set
from solving.simplify.combsimp import combsimp
from solving.simplify.cse_opts import sub_pre, sub_post
from solving.simplify.hyperexpand import hyperexpand
from solving.simplify.powsimp import powsimp
from solving.simplify.radsimp import radsimp, fraction, collect_abs
from solving.simplify.sqrtdenest import sqrtdenest
from solving.simplify.trigsimp import trigsimp, exptrigsimp
from solving.utilities.decorator import deprecated
from solving.utilities.iterables import has_variety, sift, subsets, iterable
...
def simplify(expr, ratio=1.7, measure=count_ops, rational=False, inverse=False, doit=True, **kwargs):
    ...
    from solving.physics.units import Quantity

    if expr.has(Quantity):
        from solving.physics.units.util import quantity_simplify
...
def _nthroot_solve(p, n, prec):
    ...
    """
    from solving.solvers import solve
    while n % 2 == 0:
        p = sqrtdenest(sqrt(p))
        n = n // 2
    if n == 1:
