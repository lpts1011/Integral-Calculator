...
from solving.core import sympify, S, Mul, Derivative, Pow
from solving.core.add import _unevaluated_Add, Add
from solving.core.assumptions import assumptions
from solving.core.exprtools import Factors, gcd_terms
from solving.core.function import _mexpand, expand_mul, expand_power_base
from solving.core.mul import _keep_coeff, _unevaluated_Mul, _mulsort
from solving.core.numbers import Rational, zoo, nan
from solving.core.parameters import global_parameters
from solving.core.sorting import ordered, default_sort_key
from solving.core.symbol import Dummy, Wild, symbols
from solving.functions import exp, sqrt, log
from solving.functions.elementary.complexes import Abs
from solving.polys import gcd
        ...
        while True:
            ...
            if len(rterms) > 4:
                ...
                if all(x.is_Integer and (y**2).is_Rational for x, y in rterms):
                    ...
                    keep = False
                break
            from solving.simplify.powsimp import powsimp, powdenest
