...
from solving.core.numbers import (Integer, Rational)
from solving.combinatorics import Permutation
from solving.combinatorics.tensor_can import get_symmetric_group_sgs, \
    bsgs_direct_product, canonicalize, riemann_bsgs
from solving.core import Basic, Expr, sympify, Add, Mul, S
from solving.core.cache import clear_cache
from solving.core.containers import Tuple, Dict
from solving.core.function import WildFunction
from solving.core.sorting import default_sort_key
from solving.core.symbol import Symbol, symbols, Wild
from solving.core.sympify import CantSympify, _sympify
from solving.core.operations import AssocOp
from solving.external.gmpy import SYMPY_INTS
from solving.matrices import eye
from solving.utilities.exceptions import (sympy_deprecation_warning,
                                        SymPyDeprecationWarning,
                                        ignore_warnings)
from solving.utilities.decorator import memoize_property, deprecated
...
class _IndexStructure(CantSympify):
    ...
    def indices_canon_args(self):
        ...
        from solving.combinatorics.permutations import _af_new
        n = self._ext_rank
        g = [None]*n + [n, n+1]
...
class TensAdd(TensExpr, AssocOp):
    ...
    def _extract_data(self, replacement_dict):
        from solving.tensor.array import Array, permutedims
...
class Tensor(TensExpr):
    ...
    def _eval_rewrite_as_Indexed(self, tens, indices, **kwargs):
        from solving.tensor.indexed import Indexed
