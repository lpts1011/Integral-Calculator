...
from solving.core.relational import Equality
...
from solving.core.function import (Function, Lambda)
...
from solving.matrices.expressions.diagonal import diagonalize_vector
from solving.matrices.expressions.matexpr import MatrixExpr
from solving.matrices.expressions.special import ZeroMatrix
from solving.tensor.array.arrayop import (permutedims, tensorcontraction, tensordiagonal, tensorproduct)
from solving.tensor.array.dense_ndim_array import ImmutableDenseNDimArray
from solving.tensor.array.ndim_array import NDimArray
from solving.tensor.indexed import (Indexed, IndexedBase)
from solving.matrices.expressions.matexpr import MatrixElement
from solving.tensor.array.expressions.utils import _apply_recursively_over_nested_lists, _sort_contraction_indices, \
...
from solving.combinatorics.permutations import _af_invert
...
class _EditArrayContraction:
    ...
    def merge_scalars(self):
        ...
        if len(self.args_with_ind) == 0:
            ...
            from solving.tensor.array.expressions.from_array_to_matrix import _a2m_tensor_product
