...
from solving.core._print_helpers import Printable
...
from solving.tensor.array.ndim_array import NDimArray
from solving.tensor.array.dense_ndim_array import DenseNDimArray, ImmutableDenseNDimArray
from solving.tensor.array.sparse_ndim_array import SparseNDimArray
...
def tensorproduct(*args):
    ...
    """
    from solving.tensor.array import SparseNDimArray, ImmutableSparseNDimArray

    if len(args) == 0:
        return S.One
    if len(args) == 1:
        return _arrayfy(args[0])
    from solving.tensor.array.expressions.array_expressions import _CodegenArrayAbstract
    from solving.tensor.array.expressions.array_expressions import ArrayTensorProduct
    from solving.tensor.array.expressions.array_expressions import _ArrayExpr
...
def tensorcontraction(array, *contraction_axes):
    ...
    """
    from solving.tensor.array.expressions.array_expressions import _array_contraction
    from solving.tensor.array.expressions.array_expressions import _CodegenArrayAbstract
    from solving.tensor.array.expressions.array_expressions import _ArrayExpr
    from solving.matrices.expressions.matexpr import MatrixSymbol
...
def tensordiagonal(array, *diagonal_axes):
    ...
    from solving.tensor.array.expressions.array_expressions import _ArrayExpr
    from solving.tensor.array.expressions.array_expressions import _CodegenArrayAbstract
    from solving.tensor.array.expressions.array_expressions import ArrayDiagonal, _array_diagonal
    from solving.matrices.expressions.matexpr import MatrixSymbol
    if isinstance(array, (_ArrayExpr, _CodegenArrayAbstract, MatrixSymbol)):
...
def derive_by_array(expr, dx):
    ...
    """
    from solving.matrices import MatrixBase
    from solving.tensor.array import SparseNDimArray
...
def permutedims(expr, perm=None, index_order_old=None, index_order_new=None):
    ...
    from solving.tensor.array.expressions.array_expressions import _ArrayExpr
    from solving.tensor.array.expressions.array_expressions import _CodegenArrayAbstract
    from solving.tensor.array.expressions.array_expressions import _permute_dims
    from solving.matrices.expressions.matexpr import MatrixSymbol
    from solving.tensor.array.expressions import PermuteDims
    from solving.tensor.array.expressions.array_expressions import get_rank
