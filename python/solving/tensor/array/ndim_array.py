...
from solving.core.containers import (Dict, Tuple)
...
class NDimArray(Printable):
    ...
    def __new__(cls, iterable, shape=None, **kwargs):
        from solving.tensor.array import ImmutableDenseNDimArray
    ...
    def _check_symbolic_index(self, index):
        ...
        if any((isinstance(i, Expr) and (not i.is_number)) for i in tuple_index):
            ...
            from solving.tensor import Indexed
    ...
    def applyfunc(self, f):
        ...
        """
        from solving.tensor.array import SparseNDimArray
        from solving.tensor.array.arrayop import Flatten
