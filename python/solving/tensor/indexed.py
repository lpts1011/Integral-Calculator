...
from solving.core.assumptions import StdFactKB
from solving.core import Expr, Tuple, sympify, S
from solving.core.symbol import _filter_assumptions, Symbol
from solving.core.logic import fuzzy_bool, fuzzy_not
...
from solving.utilities.iterables import is_sequence, NotIterable
...
class Indexed(Expr):
    ...
    def _eval_derivative(self, wrt):
        ...
        if isinstance(wrt, Indexed) and wrt.base == self.base:
            ...
            from solving.tensor.array import derive_by_array
