...
from solving.core import S, Symbol, Add, sympify, Expr, PoleError, Mul
...
def heuristics(e, z, z0, dir):
    ...
    if z0 is S.Infinity:
        ...
        r = []
        from solving.simplify.simplify import together
        for a in e.args:
            l = limit(a, z, z0, dir)
