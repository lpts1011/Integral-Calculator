...
from solving.functions.elementary.trigonometric import sin, cos, sinc
from solving.series.series_class import SeriesBase
from solving.series.sequences import SeqFormula
...
def finite_check(f, x, L):
    ...
    from solving.simplify.fu import TR2, TR1, sincos_to_sum
...
class FiniteFourierSeries(FourierSeries):
    ...
    def __new__(cls, f, limits, exprs):
        ...
        if not (isinstance(exprs, Tuple) and len(exprs) == 3):  # exprs is not of form (a0, an, bn)
            ...
            from solving.simplify.fu import TR10
