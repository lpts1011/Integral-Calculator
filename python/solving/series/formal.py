...
from solving.core.numbers import (nan, oo, zoo)
from solving.core.add import Add
from solving.core.expr import Expr
from solving.core.function import Derivative, Function, expand
...
from solving.core.symbol import Wild, Dummy, symbols, Symbol
from solving.core.sympify import sympify
from solving.discrete.convolutions import convolution
from solving.functions.combinatorial.factorials import binomial, factorial, rf
from solving.functions.combinatorial.numbers import bell
from solving.functions.elementary.integers import floor, frac, ceiling
...
from solving.series.sequences import sequence
from solving.series.series_class import SeriesBase
...
def rational_algorithm(f, x, k, order=4, full=False):
    ...
    """
    from solving.polys import RootSum, apart
    from solving.integrals import integrate
...
def simpleDE(f, x, g, order=4):
    ...
    """
    from solving.solvers.solveset import linsolve
...
def _compute_formula(f, x, P, Q, k, m, k_max):
    ...
    from solving.polys import roots
...
def _rsolve_hypergeometric(f, x, P, Q, k, m):
    ...
    """
    from solving.polys import lcm, roots
    from solving.integrals import integrate
...
def _solve_explike_DE(f, x, DE, g, k):
    ...
    from solving.solvers import rsolve
...
class FormalPowerSeries(SeriesBase):
    ...
    def infinite(self):
        ...
        from solving.concrete import Sum
