...
debug prints by defining the environment variable SOLVING_DEBUG. For
example:

[user@localhost]: SOLVING_DEBUG=True ./bin/isympy
...
from solving.core import Basic, S, Mul, PoleError
from solving.core.cache import cacheit
from solving.core.function import AppliedUndef
from solving.core.intfunc import ilcm
from solving.core.numbers import I, oo
from solving.core.symbol import Dummy, Wild
from solving.core.traversal import bottom_up

from solving.functions import log, exp, sign as _sign
from solving.series.order import Order
from solving.utilities.misc import debug_decorator as debug
...
def sign(e, x):
    ...
    if e.is_positive:
        ...
        from solving.simplify import logcombine
        e = logcombine(e)
        return _sign(e)
    elif e == x:
        return 1
...
def rewrite(e, Omega, x, wsym):
    ...
    from solving import AccumBounds
