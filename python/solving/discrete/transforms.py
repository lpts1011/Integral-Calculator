...
from solving.core import S, Symbol, sympify
...
from solving.ntheory import isprime, primitive_root
from solving.utilities.iterables import ibin, iterable
...
def fwht(seq):
    ...
    *radix-2 FWHT* requires the number of sample points to be a power of 2.
    ...
    >>> from solving import fwht, ifwht
...
def mobius_transform(seq, subset=True):
    ...
    >>> from solving import mobius_transform, inverse_mobius_transform
    >>> x, y, z = symbols('x y z')
