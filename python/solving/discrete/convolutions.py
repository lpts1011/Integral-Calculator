...
from solving.core import S, sympify, Rational
from solving.core.function import expand_mul
from solving.discrete.transforms import (
    fft, ifft, ntt, intt, fwht, ifwht,
    mobius_transform, inverse_mobius_transform)
from solving.external.gmpy import MPZ, lcm
...
def convolution(a, b, cycle=0, dps=None, prime=None, dyadic=None, subset=None):
    ...
    >>> from solving import convolution, symbols, S, I
...
def convolution_fft(a, b, dps=None):
    ...
    >>> from solving import S, I
    >>> from solving.discrete.convolutions import convolution_fft
...
def convolution_ntt(a, b, prime):
    ...
    >>> from solving.discrete.convolutions import convolution_ntt
...
def convolution_fwht(a, b):
    ...
    *radix-2 FWHT* requires the number of sample points to be a power of 2.
    ...
    >>> from solving import symbols, S, I
    >>> from solving.discrete.convolutions import convolution_fwht
...
def convolution_subset(a, b):
    ...
    >>> from solving import symbols, S
    >>> from solving.discrete.convolutions import convolution_subset
...
def covering_product(a, b):
    ...
    >>> from solving import symbols, S, I, covering_product
    >>> u, v, x, y, z = symbols('u v x y z')
...
def intersecting_product(a, b):
    ...
    >>> from solving import symbols, S, I, intersecting_product
    >>> u, v, x, y, z = symbols('u v x y z')
...
def convolution_int(a, b):
    ...
    >>> from solving.discrete.convolutions import convolution_int
