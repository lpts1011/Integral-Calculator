...
from solving.external.gmpy import bit_scan1, gcd, invert, sqrt as isqrt
from solving.ntheory.factor_ import _perfect_power
from solving.ntheory.primetest import isprime
from solving.ntheory.residue_ntheory import _sqrt_mod_prime_power
...
def _generate_factor_base(prime_bound, n):
    ...
    """
    from solving.ntheory.generate import sieve
    factor_base = []
