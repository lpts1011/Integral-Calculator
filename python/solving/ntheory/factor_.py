...
from solving.core.numbers import Rational, Integer
from solving.core.intfunc import num_digits
from solving.core.power import Pow
from solving.core.random import _randint
from solving.core.singleton import S
from solving.external.gmpy import (SYMPY_INTS, gcd, sqrt as isqrt,
...
from solving.utilities.iterables import flatten
...
def totient(n):
    ...
    """
    from solving.functions.combinatorial.numbers import totient as _totient
    return _totient(n)
...
def reduced_totient(n):
    ...
    """
    from solving.functions.combinatorial.numbers import reduced_totient as _reduced_totient
...
def divisor_sigma(n, k=1):
    ...
    """
    from solving.functions.combinatorial.numbers import divisor_sigma as func_divisor_sigma
...
def udivisor_sigma(n, k=1):
    ...
    """
    from solving.functions.combinatorial.numbers import udivisor_sigma as _udivisor_sigma
...
def primenu(n):
    ...
    """
    from solving.functions.combinatorial.numbers import primenu as _primenu
    return _primenu(n)
...
def primeomega(n):
    ...
    """
    from solving.functions.combinatorial.numbers import primeomega as _primeomega
