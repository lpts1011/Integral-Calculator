...
from solving.external.gmpy import (gcd, lcm, invert, sqrt, jacobi,
                                 bit_scan1, remove)
from solving.polys import Poly
from solving.polys.domains import ZZ
from solving.polys.galoistools import gf_crt1, gf_crt2, linear_congruence, gf_csolve
...
from solving.utilities.iterables import iproduct
from solving.core.random import _randint, randint
...
def legendre_symbol(a, p):
    ...
    """
    from solving.functions.combinatorial.numbers import legendre_symbol as _legendre_symbol
...
def jacobi_symbol(m, n):
    ...
    """
    from solving.functions.combinatorial.numbers import jacobi_symbol as _jacobi_symbol
...
def mobius(n):
    ...
    """
    from solving.functions.combinatorial.numbers import mobius as _mobius
    return _mobius(n)
