...
from solving.core.random import randint
from solving.external.gmpy import sqrt
...
def prime(nth):
    ...
    from solving.functions.special.error_functions import li
...
def primepi(n):
    ...
    """
    from solving.functions.combinatorial.numbers import primepi as func_primepi
