...
from solving.core.evalf import DEFAULT_MAXPREC, PrecisionExhausted
from solving.core.logic import fuzzy_and, fuzzy_or
...
from solving.polys import roots, CRootOf, ZZ, QQ, EX
from solving.polys.matrices import DomainMatrix
from solving.polys.matrices.eigen import dom_eigenvects, dom_eigenvects_to_sympy
...
def _eigenvals(
    ...
    if rational:
        from solving.simplify import nsimplify
        M = M.applyfunc(
