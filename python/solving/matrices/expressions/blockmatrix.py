from solving.assumptions.ask import (Q, ask)
from solving.core import Basic, Add, Mul, S
from solving.core.sympify import _sympify
from solving.functions.elementary.complexes import re, im
from solving.strategies import typed, exhaust, condition, do_one, unpack
from solving.strategies.traverse import bottom_up
from solving.utilities.iterables import is_sequence, sift
from solving.utilities.misc import filldedent

from solving.matrices import Matrix, ShapeError
from solving.matrices.exceptions import NonInvertibleMatrixError
from solving.matrices.expressions.determinant import det, Determinant
from solving.matrices.expressions.inverse import Inverse
from solving.matrices.expressions.matadd import MatAdd
from solving.matrices.expressions.matexpr import MatrixExpr, MatrixElement
from solving.matrices.expressions.matmul import MatMul
from solving.matrices.expressions.matpow import MatPow
from solving.matrices.expressions.slice import MatrixSlice
from solving.matrices.expressions.special import ZeroMatrix, Identity
from solving.matrices.expressions.trace import trace
from solving.matrices.expressions.transpose import Transpose, transpose
...
def block_collapse(expr):
    ...
    Matrix([[X, Z + Z*Y]])
    """
    from solving.strategies.util import expr_fns
