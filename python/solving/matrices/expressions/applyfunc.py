...
from solving.core.function import (Function, FunctionClass, Lambda)
...
class ElementwiseApplyFunction(MatrixExpr):
    ...
    def _eval_derivative(self, x):
        from solving.matrices.expressions.hadamard import hadamard_product
    ...
    def _eval_derivative_matrix_lines(self, x):
        from solving.matrices.expressions.special import Identity
        from solving.tensor.array.expressions.array_expressions import ArrayContraction
