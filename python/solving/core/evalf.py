...
if TYPE_CHECKING:
    ...
    from solving.functions.elementary.trigonometric import atan
...
def evalf_trig(v: Expr, prec: int, options: OPT_DICT) -> TMP_RES:
    ...
    """
    from solving.functions.elementary.trigonometric import cos, sin, tan
    if isinstance(v, cos):
        func = mpf_cos
...
def _create_evalf_table():
    ...
    from solving.functions.elementary.complexes import Abs, im, re
    from solving.functions.elementary.exponential import exp, log
    from solving.functions.elementary.integers import ceiling, floor
    from solving.functions.elementary.piecewise import Piecewise
    from solving.functions.elementary.trigonometric import atan, cos, sin, tan
    from solving.integrals.integrals import Integral
    evalf_table = {
        Symbol: evalf_symbol,
        Dummy: evalf_symbol,
...
def evalf(x: Expr, prec: int, options: OPT_DICT) -> TMP_RES:
    ...
    """
    from solving.functions.elementary.complexes import re as re_, im as im_
    try:
