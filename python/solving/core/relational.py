...
from solving.logic.boolalg import Boolean, BooleanAtom
        ...
        if r.is_Relational:
            ...
            if len(free) == 1:
                try:
                    ...
                    from solving.polys.polytools import gcd, Poly, poly
                    try:
                        p = poly(dif, x)
                        c = p.all_coeffs()
                        constant = c[-1]
...
def is_ge(lhs, rhs, assumptions=None):
    ...
    *rhs* is indeterminate.
    ...
    True
    """
    from solving.assumptions.wrapper import AssumptionsWrapper, is_extended_nonnegative
...
def is_eq(lhs, rhs, assumptions=None):
    ...
    from solving.assumptions.wrapper import (AssumptionsWrapper,
