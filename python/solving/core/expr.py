...
from solving.utilities.misc import as_int, func_name, filldedent
from solving.utilities.iterables import has_variety, sift
...
class Expr(Basic, EvalfMixin):
    ...
    def __abs__(self) -> Expr:
        from solving.functions.elementary.complexes import Abs
        return Abs(self)
    ...
    def __floordiv__(self, other) -> Expr:
        from solving.functions.elementary.integers import floor
    ...
    def _random(self, n=None, re_min=-1, im_min=-1, re_max=1, im_max=1):
        ...
        prec = 1
        if free:
            from solving.core.random import random_complex_number
    ...
    def is_constant(self, *wrt, **flags):
        ...
        for w in wrt_number:
            ...
            if deriv != 0:
                ...
                return False
        from solving.solvers.solvers import denoms
    ...
    def equals(self, other, failing_expression=False):
        ...
        """
        from solving.simplify.simplify import nsimplify, simplify
        from solving.solvers.solvers import solve
        from solving.polys.polyerrors import NotAlgebraic
        from solving.polys.numberfields import minimal_polynomial
    ...
    def _eval_interval(self, x, a, b):
        ...
        """
        from solving.calculus.accumulationbounds import AccumBounds
        from solving.functions.elementary.exponential import log
        from solving.series.limits import limit, Limit
    ...
    def conjugate(self):
        ...
        from solving.functions.elementary.complexes import conjugate as c
        return c(self)
    ...
    def _eval_transpose(self):
        from solving.functions.elementary.complexes import conjugate
    ...
    def transpose(self):
        from solving.functions.elementary.complexes import transpose
        return transpose(self)

    def _eval_adjoint(self):
        from solving.functions.elementary.complexes import conjugate, transpose
    ...
    def adjoint(self):
        from solving.functions.elementary.complexes import adjoint
        return adjoint(self)

    @classmethod
    def _parse_order(cls, order):
        """Parse and configure the ordering of terms. """
        from solving.polys.orderings import monomial_key
    ...
    def as_poly(self, *gens, **args):
        ...
        """
        from solving.polys.polyerrors import PolynomialError, GeneratorsNeeded
        from solving.polys.polytools import Poly
    ...
    def as_real_imag(self, deep=True, **hints) -> tuple[Expr, Expr]:
        ...
        if hints.get('ignore') == self:
            ...
            from solving.functions.elementary.complexes import im, re
    ...
    def extract_multiplicatively(self, c: Expr) -> Expr | None:
        ...
        """
        from solving.functions.elementary.exponential import exp
        from .add import _unevaluated_Add
        c = sympify(c)
        if self is S.NaN:
            return None
    ...
    def extract_branch_factor(self, allow_half=False):
        ...
        (1, -1/2)
        """
        from solving.functions.elementary.exponential import exp_polar
        from solving.functions.elementary.integers import ceiling
    ...
    def series(self, x=None, x0=0, n=6, dir="+", logx=None, cdir=0):
        ...
        x0 = sympify(x0)
        cdir = sympify(cdir)
        from solving.functions.elementary.complexes import im, sign
        ...
        from solving.series.order import Order
        if n is not None:  # nseries handling
            ...
            try:
                from solving.simplify.radsimp import collect
    ...
    def aseries(self, x=None, n=6, bound=0, hir=False):
        ...
        from .function import PoleError
        from solving.series.gruntz import mrv, rewrite
        ...
        from solving.functions.elementary.exponential import exp, log
        from solving.series.order import Order
        ...
        s = func.series(k, 0, n)
        from solving.core.function import expand_mul
        s = expand_mul(s)
        # Hierarchical series
        if hir:
    ...
    def taylor_term(self, n, x, *previous_terms):
        ...
        """
        from .symbol import Dummy
        from solving.functions.combinatorial.factorials import factorial
    ...
    def limit(self, x, xlim, dir='+'):
        ...
        """
        from solving.series.limits import limit
    ...
    def as_leading_term(self, *symbols, logx=None, cdir=0):
        ...
        if obj is not None:
            from solving.simplify.powsimp import powsimp
    ...
    def fps(self, x=None, x0=0, dir=1, hyper=True, order=4, rational=True,
        ...
        more information.
        """
        from solving.series.formal import fps
    ...
    def expand(self, deep=True, modulus=None, power_base=True, power_exp=True,
        ...
        """
        from solving.simplify.radsimp import fraction
    ...
    def integrate(self, *args, **kwargs):
        ...
        from solving.integrals.integrals import integrate
    ...
    def together(self, *args, **kwargs):
        ...
        from solving.polys.rationaltools import together
        return together(self, *args, **kwargs)

    def apart(self, x=None, **args):
        """See the apart function in sympy.polys"""
        from solving.polys.partfrac import apart
        return apart(self, x, **args)

    def ratsimp(self):
        """See the ratsimp function in sympy.simplify"""
        from solving.simplify.ratsimp import ratsimp
        return ratsimp(self)

    def trigsimp(self, **args):
        """See the trigsimp function in sympy.simplify"""
        from solving.simplify.trigsimp import trigsimp
        return trigsimp(self, **args)

    def radsimp(self, **kwargs):
        """See the radsimp function in sympy.simplify"""
        from solving.simplify.radsimp import radsimp
    ...
    def combsimp(self):
        ...
        from solving.simplify.combsimp import combsimp
        return combsimp(self)

    def gammasimp(self):
        """See the gammasimp function in sympy.simplify"""
        from solving.simplify.gammasimp import gammasimp
        return gammasimp(self)

    def factor(self, *gens, **args):
        """See the factor() function in sympy.polys.polytools"""
        from solving.polys.polytools import factor
        return factor(self, *gens, **args)

    def cancel(self, *gens, **args):
        """See the cancel function in sympy.polys"""
        from solving.polys.polytools import cancel
    ...
    def invert(self, g, *gens, **args):
        ...
        from solving.polys.polytools import invert
    ...
    def _eval_derivative_matrix_lines(self, x):
        from solving.matrices.expressions.matexpr import _LeftRightArgs
...
class AtomicExpr(Atom, Expr):
    ...
    def _eval_derivative_n_times(self, s, n):
        ...
        from solving.matrices.expressions.matexpr import MatrixExpr
        from solving.matrices.matrixbase import MatrixBase
