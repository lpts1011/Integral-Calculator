...
class Mul(Expr, AssocOp):
    ...
    def _eval_derivative_n_times(self, s, n):
        ...
        if isinstance(n, (int, Integer)):
            ...
            terms = []
            from solving.ntheory.multinomial import multinomial_coefficients_iterator
        ...
        from solving.functions.elementary.miscellaneous import Max
    ...
    def _eval_difference_delta(self, n, step):
        from solving.series.limitseq import difference_delta as dd
        arg0 = self.args[0]
    ...
    def _eval_subs(self, old, new):
        from solving.functions.elementary.complexes import sign
        from solving.ntheory.factor_ import multiplicity
    ...
    def _eval_nseries(self, x, n, logx, cdir=0):
        ...
        if self.is_polynomial(x):
            ...
            from solving.polys.polytools import degree
            try:
