...
from solving.utilities.iterables import (has_dups, sift, iterable,
    is_sequence, uniq, topological_sort)
from solving.utilities.lambdify import MPMATH_TRANSLATIONS
from solving.utilities.misc import as_int, filldedent, func_name
...
class Application(Basic, metaclass=FunctionClass):
    ...
    def __new__(cls, *args, **options):
        from solving.sets.fancysets import Naturals0
        from solving.sets.sets import FiniteSet
...
class WildFunction(Function, AtomicExpr):  # type: ignore
    ...
    def __init__(cls, name, **assumptions):
        from solving.sets.sets import Set, FiniteSet
        cls.name = name
...
class Derivative(Expr):
    ...
    def __new__(cls, expr, *variables, **kwargs):
        ...
        from solving.tensor.array import Array, NDimArray
    ...
    def as_finite_difference(self, points=1, x0=None, wrt=None):
        ...
        """
        from solving.calculus.finite_diff import _as_finite_diff
    ...
    if factor is False:
        def _handleMul(x):
            ...
            if len(n) == 1 and len(d) == 1:
                n = n[0]
                d = d[0]
                from solving import multiplicity
...
def count_ops(expr, visual=False):
    ...
    from solving.logic.boolalg import BooleanFunction
    from solving.simplify.radsimp import fraction
...
def nfloat(expr, n=15, exponent=False, dkeys=False):
    ...
    from solving.polys.rootoftools import RootOf
