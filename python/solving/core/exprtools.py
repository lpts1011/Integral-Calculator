...
from solving.utilities.iterables import (common_prefix, common_suffix,
...
def _monotonic_sign(self):
    ...
    if len(free) == 1:
        if self.is_polynomial():
            from solving.polys.polytools import real_roots
...
def factor_nc(expr):
    ...
    from solving.polys.polytools import gcd, factor
