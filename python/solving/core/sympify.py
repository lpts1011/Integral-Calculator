...
import string
from solving.core.random import choice
...
if TYPE_CHECKING:
    ...
    from solving.core.numbers import Integer, Float
...
def sympify(a, locals=None, convert_xor=True, strict=False, rational=False,
    ...
    To parse non-Python syntax, use ``parse_expr`` from ``sympy.parsing.solving_parser``.

    >>> from sympy.parsing.solving_parser import parse_expr
    >>> parse_expr("2x+1", transformations="all")
    2*x + 1

    For more details about ``transformations``: see :func:`~sympy.parsing.solving_parser.parse_expr`
    ...
    if not strict:
        ...
        if flat is not None:
            ...
            if shape is not None:
                from solving.tensor.array import Array
    ...
    from solving.parsing.solving_parser import (parse_expr, TokenError,
                                            standard_transformations)
    from solving.parsing.solving_parser import convert_xor as t_convert_xor
    from solving.parsing.solving_parser import rationalize as t_rationalize
