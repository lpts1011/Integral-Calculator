...
if USE_SYMENGINE:
    ...
    from solving.core.function import (diff, Function, AppliedUndef,
        expand, Derivative)
    from solving.core.mul import Mul
    from solving.core.intfunc import igcd
    from solving.core.numbers import pi, I, Integer, Rational, E
    from solving.core.singleton import S
    from solving.core.symbol import Symbol, var, symbols
    from solving.core.sympify import SympifyError, sympify
    from solving.functions.elementary.exponential import log, exp
    from solving.functions.elementary.hyperbolic import (coth, sinh,
        acosh, acoth, tanh, asinh, atanh, cosh)
    from solving.functions.elementary.miscellaneous import sqrt
    from solving.functions.elementary.trigonometric import (csc,
        asec, cos, atan, sec, acot, asin, tan, sin, cot, acsc, acos)
    from solving.functions.special.gamma_functions import gamma
    from solving.matrices.dense import (eye, zeros, diag, Matrix,
        ones, symarray)
