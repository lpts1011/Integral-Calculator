...
from solving.external.gmpy import SYMPY_INTS, gmpy, flint
...
class Number(AtomicExpr):
    ...
    def lcm(self, other):
        ...
        from solving.polys.polytools import lcm
        return lcm(self, other)

    def cofactors(self, other):
        """Compute GCD and cofactors of `self` and `other`. """
        from solving.polys.polytools import cofactors
...
class Rational(Number):
    ...
    def factors(self, limit=None, use_trial=True, use_rho=False,
        ...
        """
        from solving.ntheory.factor_ import factorrat
...
class Integer(Rational):
    ...
    def _eval_power(self, expt):
        ...
        """
        from solving.ntheory.factor_ import perfect_power
    ...
    def _eval_is_prime(self):
        from solving.ntheory.primetest import isprime
...
class AlgebraicNumber(Expr):
    ...
    def __new__(cls, expr, coeffs=None, alias=None, **args):
        ...
        """
        from solving.polys.polyclasses import ANP, DMP
    ...
    def as_poly(self, x=None):
        ...
        from solving.polys.polytools import Poly, PurePoly
        if x is not None:
    ...
    def _eval_simplify(self, **kwargs):
        ...
        from solving.polys import minpoly
    ...
    def minpoly_of_element(self):
        ...
        if self._own_minpoly is None:
            if self.is_primitive_element:
                ...
                from solving.polys.numberfields.minpoly import minpoly
