...
from solving.utilities.iterables import sift
from solving.utilities.exceptions import sympy_deprecation_warning
from solving.utilities.misc import as_int
from solving.multipledispatch import Dispatcher
...
class Pow(Expr):
            ...
            if S.NaN in (base, exp):  # XXX S.NaN**x -> S.NaN under assumption that x != 0
                ...
                if not exp.is_Atom and base is not S.Exp1 and not isinstance(base, exp_polar):
                    ...
                    if isinstance(den, log) and den.args[0] == base:
                        ...
                        from solving.functions.elementary.complexes import sign, im
                        s = sign(im(base))
    ...
    def _eval_refine(self, assumptions):
        from solving.assumptions.ask import ask, Q
    ...
    def _eval_power(self, expt):
        ...
        if expt.is_integer:
            ...
            from solving.functions.elementary.complexes import arg, im, re, sign
    ...
    def _eval_Mod(self, q):
        ...
        if exp.is_integer and exp.is_positive:
            ...
            from solving.functions.combinatorial.numbers import totient
    ...
    def _eval_is_extended_real(self):
        ...
        from solving.functions.elementary.exponential import log, exp
        ...
        if real_b is False and real_e: # we already know it's not imag
            if isinstance(self.exp, Rational) and self.exp.p == 1:
                return False
            from solving.functions.elementary.complexes import arg
    ...
    def _eval_expand_power_exp(self, **hints):
        ...
        e = self.exp
        if b == S.Exp1:
            from solving.concrete.summations import Sum
            if isinstance(e, Sum) and e.is_commutative:
                from solving.concrete.products import Product
    ...
    def _eval_expand_multinomial(self, **hints):
        ...
        if exp.is_Rational and exp.p > 0 and base.is_Add:
            ...
            if base.is_commutative:
                ...
                # coefficients first:
                from solving.ntheory.multinomial import multinomial_coefficients
                from solving.polys.polyutils import basic_from_dict
    ...
    def as_real_imag(self, deep=True, **hints):
        ...
        from solving.functions.elementary.trigonometric import atan2, cos, sin
    ...
    def _eval_evalf(self, prec):
        ...
        if base == S.Exp1:
            ...
            from solving.functions.elementary.exponential import exp as exp_function
    ...
    def _eval_rewrite_as_exp(self, base, expo, **kwargs):
        ...
        if base.has(Symbol):
            ...
            from solving.functions.elementary.complexes import arg, Abs
    ...
    def _eval_nseries(self, x, n, logx, cdir=0):
        ...
        from solving.simplify.powsimp import powdenest
        ...
        b = b.removeO()
        try:
            from solving.functions.special.gamma_functions import polygamma
        ...
        if e.has(log):
            from solving.simplify.simplify import logcombine
        ...
        from solving.functions.combinatorial.factorials import factorial, ff
        ...
        from solving.functions.elementary.complexes import im
    ...
    def _taylor_term(self, n, x, *previous_terms): # of (1 + x)**e
        from solving.functions.combinatorial.factorials import binomial
    ...
    def _eval_rewrite_as_sin(self, base, exp, **hints):
        if self.base is S.Exp1:
            from solving.functions.elementary.trigonometric import sin
    ...
    def _eval_rewrite_as_cos(self, base, exp, **hints):
        if self.base is S.Exp1:
            from solving.functions.elementary.trigonometric import cos
    ...
    def _eval_rewrite_as_tanh(self, base, exp, **hints):
        if self.base is S.Exp1:
            from solving.functions.elementary.hyperbolic import tanh
            return (1 + tanh(self.exp/2))/(1 - tanh(self.exp/2))

    def _eval_rewrite_as_sqrt(self, base, exp, **kwargs):
        from solving.functions.elementary.trigonometric import sin, cos
