from solving.combinatorics.permutations import Permutation, _af_invert, _af_rmul
...
def _orbits_transversals_from_bsgs(base, strong_gens_distr,
    ...
    """
    from solving.combinatorics.perm_groups import _orbit_transversal
    base_len = len(base)
...
def _remove_gens(base, strong_gens, basic_orbits=None, strong_gens_distr=None):
    ...
    """
    from solving.combinatorics.perm_groups import _orbit
    base_len = len(base)
