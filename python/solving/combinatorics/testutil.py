...
from solving.combinatorics.util import _distribute_gens_by_base
...
def _naive_list_centralizer(self, other, af=False):
    from solving.combinatorics.perm_groups import PermutationGroup
    """
    ...
    """
    from solving.combinatorics.permutations import _af_commutes_with
...
def canonicalize_naive(g, dummies, sym, *v):
    ...
    """
    from solving.combinatorics.perm_groups import PermutationGroup
    from solving.combinatorics.tensor_can import gens_products, dummy_sgs
    from solving.combinatorics.permutations import _af_rmul
    v1 = []
...
def graph_certificate(gr):
    ...
    from solving.combinatorics.tensor_can import get_symmetric_group_sgs, canonicalize
    items = list(gr.items())
