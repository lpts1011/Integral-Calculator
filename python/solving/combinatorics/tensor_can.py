from solving.combinatorics.permutations import Permutation, _af_rmul, \
    _af_invert, _af_new
from solving.combinatorics.perm_groups import PermutationGroup, _orbit, \
    _orbit_transversal
...
def canonicalize(g, dummies, msym, *v):
    ...
    """
    from solving.combinatorics.testutil import canonicalize_naive
